...
common_task = CommonTask(dag_id='a_flow_7', dag_params={})
lineage_task = LineageTask(dag_id='a_flow_7', dag_params={})
...
with DAG(
    ...
    def create_databricks_cluster_create_compute_dfc4acc1d(**context):
    ...
    create_compute_dfc4acc1d = PythonOperator(
        task_id='create_compute_dfc4acc1d',
        python_callable=create_databricks_cluster_create_compute_dfc4acc1d,
        on_success_callback=common_task.success_callback,
        on_failure_callback=common_task.failure_callback,
    )
    ...
    _submit_params = {
        "compute_task_id": "create_compute_dfc4acc1d",
        "job_config": {
            "job_type": "spark_python",
            "name": "{{ dag.dag_id }}_submit_job_e61402024_{{ ts_nodash }}",
    ...
    submit_job_e61402024 = PythonOperator(
        pre_execute=common_task.pre_execute_callback,
        task_id='submit_job_e61402024',
    ...
    start_flow_task >> create_compute_dfc4acc1d
    create_compute_dfc4acc1d >> submit_job_e61402024
    submit_job_e61402024 >> end_flow_task
