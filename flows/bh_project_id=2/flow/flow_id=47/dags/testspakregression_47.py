...
common_task = CommonTask(dag_id='testspakregression_47', dag_params={})
lineage_task = LineageTask(dag_id='testspakregression_47', dag_params={})
...
with DAG(
    ...
    start_flow_task = PythonOperator(
        ...
        params = {
            'flow_id': 47,
            'flow_name': 'Testspakregression',
            'flow_key': 'testspakregression',
            'bh_project_id': 2,
    ...
    spark_app_yaml_spark_operator_a164d2a44 = f'''
    apiVersion: "sparkoperator.k8s.io/v1beta2"
    kind: SparkApplication
    metadata:
      name: "spark-app-spark-operator-a164d2a44"
    ...
    spark_operator_a164d2a44 = SparkKubernetesOperator(
        task_id='spark_operator_a164d2a44',
        namespace="spark-operator",
        application_file=spark_app_yaml_spark_operator_a164d2a44,
    ...
    start_flow_task >> spark_operator_a164d2a44
    spark_operator_a164d2a44 >> end_flow_task
