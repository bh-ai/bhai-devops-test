...
common_task = CommonTask(dag_id='dbricks_test04', dag_params={})
lineage_task = LineageTask(dag_id='dbricks_test04', dag_params={})
...
with DAG(
    ...
    start_flow_task = PythonOperator(
        ...
        params = {
            'flow_id': 16,
            'flow_name': 'dbricks-test04',
            'flow_key': 'dbricks_test04',
            'bh_project_id': 2,
    ...
    custom_8214ee45d = PythonOperator(
        task_id='custom_8214ee45d',
        python_callable=create_databricks_cluster_custom_8214ee45d,
        on_success_callback=common_task.success_callback,
        on_failure_callback=common_task.failure_callback,
    )
    ...
    start_flow_task >> custom_8214ee45d
    custom_8214ee45d >> end_flow_task
