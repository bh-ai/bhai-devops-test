...
common_task = CommonTask(dag_id='gcp_bhignite_changes_52', dag_params={})
lineage_task = LineageTask(dag_id='gcp_bhignite_changes_52', dag_params={})
...
with DAG(
    dag_id='gcp_bhignite_changes_52',
    ...
    start_flow_task = PythonOperator(
        ...
        params = {
            'flow_id': 52,
            'flow_name': 'gcp-bhignite-changes',
            'flow_key': 'gcp_bhignite_changes',
            'bh_project_id': 2,
    ...
    spark_app_yaml_bh_ignite_a2843aa31 = f'''
    apiVersion: "sparkoperator.k8s.io/v1beta2"
    kind: SparkApplication
    metadata:
      name: "spark-app-bh-ignite-a2843aa31"
    ...
    bh_ignite_a2843aa31 = SparkKubernetesOperator(
        task_id='bh_ignite_a2843aa31',
        namespace="spark-operator",
        application_file=spark_app_yaml_bh_ignite_a2843aa31,
    ...
    start_flow_task >> bh_ignite_a2843aa31
    bh_ignite_a2843aa31 >> end_flow_task
