...
common_task = CommonTask(dag_id='pipeline_test_03_3_61', dag_params={})
lineage_task = LineageTask(dag_id='pipeline_test_03_3_61', dag_params={})
...
with DAG(
    ...
    start_flow_task = PythonOperator(
        ...
        params = {
            'flow_id': 61,
            'flow_name': 'pipeline-test-03_3',
            'flow_key': 'pipeline_test_03_3',
            'bh_project_id': 2,
    ...
    _submit_params = {
        ...
        "job_config": {
            ...
            "name": "{{ dag.dag_id }}_run_job_{{ ts_nodash }}",
            "python_file": "/Workspace/Shared/dev-utils/pipelines/main.py",
            "parameters": [
                "/Workspace/Shared/codespace/pipelines/bh_project_id=2/pipeline/pipeline_id=3/pipeline-test-03.json",
                "databricks",
        ...
        "flow_id": 61,
        "pipeline_id": "3",
        "pipeline_name": "pipeline-test-03",
        "pipeline_key": "pipeline-test-03",
        "bh_project_id": 2,
        "project_id": 2,
        "project_name": "flow-service-project",
    ...
    create_compute >> run_job
    run_job >> delete_compute
