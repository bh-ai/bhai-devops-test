...
common_task = CommonTask(dag_id='dbricks_10', dag_params={})
lineage_task = LineageTask(dag_id='dbricks_10', dag_params={})
...
with DAG(
    ...
    def create_databricks_cluster_custom_3e14d4a7c(**context):
    ...
    custom_3e14d4a7c = PythonOperator(
        task_id='custom_3e14d4a7c',
        python_callable=create_databricks_cluster_custom_3e14d4a7c,
        on_success_callback=common_task.success_callback,
        on_failure_callback=common_task.failure_callback,
    )
    ...
    start_flow_task >> custom_3e14d4a7c
    custom_3e14d4a7c >> end_flow_task
