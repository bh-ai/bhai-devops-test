...
common_task = CommonTask(dag_id='spark_engine_49', dag_params={})
lineage_task = LineageTask(dag_id='spark_engine_49', dag_params={})
...
with DAG(
    ...
    start_flow_task = PythonOperator(
        ...
        params = {
            'flow_id': 49,
            'flow_name': 'spark-engine',
            'flow_key': 'spark_engine',
            'bh_project_id': 2,
    ...
    spark_app_yaml_spark_engine_4d743505b = f'''
    apiVersion: "sparkoperator.k8s.io/v1beta2"
    kind: SparkApplication
    metadata:
      name: "spark-app-spark-engine-4d743505b"
    ...
    spark_engine_4d743505b = SparkKubernetesOperator(
        task_id='spark_engine_4d743505b',
        namespace="spark-operator",
        application_file=spark_app_yaml_spark_engine_4d743505b,
    ...
    start_flow_task >> spark_engine_4d743505b
    spark_engine_4d743505b >> end_flow_task
