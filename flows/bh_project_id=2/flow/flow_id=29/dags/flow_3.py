...
common_task = CommonTask(dag_id='flow_3', dag_params={})
lineage_task = LineageTask(dag_id='flow_3', dag_params={})
...
with DAG(
    ...
    def create_databricks_cluster_create_compute_e2c45e15f(**context):
    ...
    create_compute_e2c45e15f = PythonOperator(
        task_id='create_compute_e2c45e15f',
        python_callable=create_databricks_cluster_create_compute_e2c45e15f,
        on_success_callback=common_task.success_callback,
        on_failure_callback=common_task.failure_callback,
    )
    ...
    _submit_params = {
        "compute_task_id": "create_compute_e2c45e15f",
        "job_config": {
            "job_type": "spark_python",
            "name": "{{ dag.dag_id }}_submit_job_53b4e3174_{{ ts_nodash }}",
    ...
    submit_job_53b4e3174 = PythonOperator(
        pre_execute=common_task.pre_execute_callback,
        task_id='submit_job_53b4e3174',
    ...
    start_flow_task >> create_compute_e2c45e15f
    create_compute_e2c45e15f >> submit_job_53b4e3174
    submit_job_53b4e3174 >> end_flow_task
