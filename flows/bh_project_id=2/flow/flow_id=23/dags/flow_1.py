...
with DAG(
    ...
    def create_databricks_cluster_custom_0534c8d15(**context):
    ...
    custom_0534c8d15 = PythonOperator(
        task_id='custom_0534c8d15',
        python_callable=create_databricks_cluster_custom_0534c8d15,
        on_success_callback=common_task.success_callback,
        on_failure_callback=common_task.failure_callback,
    )
    ...
    start_flow_task >> custom_0534c8d15
    custom_0534c8d15 >> end_flow_task
