...
common_task = CommonTask(dag_id='flow_1', dag_params={})
lineage_task = LineageTask(dag_id='flow_1', dag_params={})
...
with DAG(
    ...
    def create_databricks_cluster_custom_017482567(**context):
    ...
    custom_017482567 = PythonOperator(
        task_id='custom_017482567',
        python_callable=create_databricks_cluster_custom_017482567,
        on_success_callback=common_task.success_callback,
        on_failure_callback=common_task.failure_callback,
    )
    ...
    _submit_params = {
        "compute_task_id": "custom_017482567",
        "job_config": {
            "job_type": "spark_python",
            "name": "{{ dag.dag_id }}_custom_18949f3aa_{{ ts_nodash }}",
            "python_file": "/Workspace/Shared/bh-dev-utils/pipelines/main.py",
            "parameters": [
                "/Workspace/Shared/codespace/pipelines/bh_project_id=2/pipeline/pipeline_id=2/pipeline-flow-test.json",
                "databricks",
    ...
    custom_18949f3aa = PythonOperator(
        pre_execute=common_task.pre_execute_callback,
        task_id='custom_18949f3aa',
    ...
    start_flow_task >> custom_017482567
    custom_017482567 >> custom_18949f3aa
    custom_18949f3aa >> end_flow_task
