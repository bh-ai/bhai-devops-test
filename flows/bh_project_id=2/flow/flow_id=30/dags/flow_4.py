...
common_task = CommonTask(dag_id='flow_4', dag_params={})
lineage_task = LineageTask(dag_id='flow_4', dag_params={})
...
with DAG(
    ...
    def create_databricks_cluster_create_compute_c51406070(**context):
    ...
    create_compute_c51406070 = PythonOperator(
        task_id='create_compute_c51406070',
        python_callable=create_databricks_cluster_create_compute_c51406070,
        on_success_callback=common_task.success_callback,
        on_failure_callback=common_task.failure_callback,
    )
    ...
    _submit_params = {
        "compute_task_id": "create_compute_c51406070",
        "job_config": {
            "job_type": "spark_python",
            "name": "{{ dag.dag_id }}_submit_job_7a049fe33_{{ ts_nodash }}",
    ...
    submit_job_7a049fe33 = PythonOperator(
        pre_execute=common_task.pre_execute_callback,
        task_id='submit_job_7a049fe33',
    ...
    start_flow_task >> create_compute_c51406070
    create_compute_c51406070 >> submit_job_7a049fe33
    submit_job_7a049fe33 >> end_flow_task
