...
common_task = CommonTask(dag_id='claim_op12_938_744', dag_params={})
lineage_task = LineageTask(dag_id='claim_op12_938_744', dag_params={})
...
with DAG(
    ...
    start_flow_task = PythonOperator(
        ...
        params = {
            'flow_id': 744,
            'flow_name': 'claim_op12_938',
            'flow_key': 'claim_op12_938',
            'bh_project_id': 104,
    ...
    _submit_params = {
        ...
        "job_config": {
            ...
            "name": "{{ dag.dag_id }}_run_pipelines_claim_op12_{{ ts_nodash }}",
            "python_file": "/Workspace/Shared/dev-utils/pipelines/main.py",
            "parameters": [
                "/Workspace/Shared/codespace/pipelines/bh_project_id=104/pipeline/pipeline_id=1669/claim_op12.json",
                "databricks",
        ...
        "pipeline_name": "claim_op12",
        "airflow_connection_id": "databricks_default",
        "pipeline_key": "claim_op12",
        "bh_project_id": 104,
        "project_id": 104,
        "project_name": "bighammer",
    ...
    run_pipelines_claim_op12 = PythonOperator(
        pre_execute=common_task.pre_execute_callback,
        task_id='run_pipelines_claim_op12',
    ...
    _submit_params = {
        ...
        "job_config": {
            "job_type": "spark_python",
            "name": "{{ dag.dag_id }}_run_pipelines_silver_raw_fideliscare_claims_to_pharmacy_pipeline_260825_9c54_{{ ts_nodash }}",
            "python_file": "/Workspace/Shared/dev-utils/pipelines/main.py",
            "parameters": [
                "/Workspace/Shared/codespace/pipelines/bh_project_id=104/pipeline/pipeline_id=1670/silver_raw_fideliscare_claims_to_pharmacy_pipeline_260825_9c54.json",
                "databricks",
                "/Workspace/Shared/dev-utils/schemas"
            ]
        },
        ...
        "validate_inbound_task_id": "validate_inbound_files",
        "facts_source": "databricks",
        "pipeline_name": "silver_raw_fideliscare_claims_to_pharmacy_pipeline_260825_9c54",
        "airflow_connection_id": "databricks_default",
        "pipeline_key": "silver_raw_fideliscare_claims_to_pharmacy_pipeline_260825_9c54",
        "bh_project_id": 104,
        "project_id": 104,
        "project_name": "bighammer",
        "compute_xcom_key": "return_value",
    ...
    run_pipelines_silver_raw_fideliscare_claims_to_pharmacy_pipeline_260825_9c54 = PythonOperator(
        pre_execute=common_task.pre_execute_callback,
        task_id='run_pipelines_silver_raw_fideliscare_claims_to_pharmacy_pipeline_260825_9c54',
        python_callable=submit_job_to_cluster,
        params=_submit_params,
        on_success_callback=feed_control_callbacks.submit_job_success_callback,
        on_failure_callback=feed_control_callbacks.submit_job_failure_callback,
    ...
    _submit_params = {
        ...
        "job_config": {
            "job_type": "spark_python",
            "name": "{{ dag.dag_id }}_run_pipelines_pharmacy_silver_ods_113_20260825075519_{{ ts_nodash }}",
            "python_file": "/Workspace/Shared/dev-utils/pipelines/main.py",
            "parameters": [
                "/Workspace/Shared/codespace/pipelines/bh_project_id=104/pipeline/pipeline_id=1672/pharmacy_silver_ods_113_20260825075519.json",
                "databricks",
                "/Workspace/Shared/dev-utils/schemas"
            ]
        },
        ...
        "validate_inbound_task_id": "validate_inbound_files",
        "facts_source": "databricks",
        "pipeline_name": "pharmacy_silver_ods_113_20260825075519",
        "airflow_connection_id": "databricks_default",
        "pipeline_key": "pharmacy_silver_ods_113_20260825075519",
        "bh_project_id": 104,
        "project_id": 104,
        "project_name": "bighammer",
        "compute_xcom_key": "return_value",
    ...
    run_pipelines_pharmacy_silver_ods_113_20260825075519 = PythonOperator(
        pre_execute=common_task.pre_execute_callback,
        task_id='run_pipelines_pharmacy_silver_ods_113_20260825075519',
        python_callable=submit_job_to_cluster,
        params=_submit_params,
        on_success_callback=feed_control_callbacks.submit_job_success_callback,
        on_failure_callback=feed_control_callbacks.submit_job_failure_callback,
    ...
    _submit_params = {
        ...
        "job_config": {
            "job_type": "spark_python",
            "name": "{{ dag.dag_id }}_run_pipelines_pharmacy_silver_ods_113_20260825080258_{{ ts_nodash }}",
            "python_file": "/Workspace/Shared/dev-utils/pipelines/main.py",
            "parameters": [
                "/Workspace/Shared/codespace/pipelines/bh_project_id=104/pipeline/pipeline_id=1673/pharmacy_silver_ods_113_20260825080258.json",
                "databricks",
                "/Workspace/Shared/dev-utils/schemas"
            ]
        },
        ...
        "validate_inbound_task_id": "validate_inbound_files",
        "facts_source": "databricks",
        "pipeline_name": "pharmacy_silver_ods_113_20260825080258",
        "airflow_connection_id": "databricks_default",
        "pipeline_key": "pharmacy_silver_ods_113_20260825080258",
        "bh_project_id": 104,
        "project_id": 104,
        "project_name": "bighammer",
        "compute_xcom_key": "return_value",
    ...
    run_pipelines_pharmacy_silver_ods_113_20260825080258 = PythonOperator(
        pre_execute=common_task.pre_execute_callback,
        task_id='run_pipelines_pharmacy_silver_ods_113_20260825080258',
        python_callable=submit_job_to_cluster,
        params=_submit_params,
        on_success_callback=feed_control_callbacks.submit_job_success_callback,
        on_failure_callback=feed_control_callbacks.submit_job_failure_callback,
    ...
    run_pipelines_claim_op12 >> run_pipelines_silver_raw_fideliscare_claims_to_pharmacy_pipeline_260825_9c54
    create_compute >> run_pipelines_silver_raw_fideliscare_claims_to_pharmacy_pipeline_260825_9c54
    run_pipelines_silver_raw_fideliscare_claims_to_pharmacy_pipeline_260825_9c54 >> run_pipelines_pharmacy_silver_ods_113_20260825075519
    create_compute >> run_pipelines_pharmacy_silver_ods_113_20260825075519
    run_pipelines_pharmacy_silver_ods_113_20260825075519 >> run_pipelines_pharmacy_silver_ods_113_20260825080258
    create_compute >> run_pipelines_pharmacy_silver_ods_113_20260825080258
    run_pipelines_pharmacy_silver_ods_113_20260825080258 >> archive_processed_files
