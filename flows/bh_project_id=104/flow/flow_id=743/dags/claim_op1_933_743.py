...
common_task = CommonTask(dag_id='claim_op1_933_743', dag_params={})
lineage_task = LineageTask(dag_id='claim_op1_933_743', dag_params={})
...
with DAG(
    ...
    start_flow_task = PythonOperator(
        ...
        params = {
            'flow_id': 743,
            'flow_name': 'claim_op1_933',
            'flow_key': 'claim_op1_933',
            'bh_project_id': 104,
    ...
    _submit_params = {
        ...
        "job_config": {
            ...
            "name": "{{ dag.dag_id }}_run_jobs_claim_op1_{{ ts_nodash }}",
            "python_file": "/Workspace/Shared/dev-utils/pipelines/main.py",
            "parameters": [
                "/Workspace/Shared/codespace/pipelines/bh_project_id=104/pipeline/pipeline_id=1629/claim_op1.json",
                "databricks",
        ...
        "flow_id": 743,
        "pipeline_id": "1629",
        "pipeline_name": "claim_op1",
        "airflow_connection_id": "databricks_default",
        "pipeline_key": "claim_op1",
        "bh_project_id": 104,
        "project_id": 104,
        "project_name": "bighammer",
    ...
    run_jobs_claim_op1 = PythonOperator(
        pre_execute=common_task.pre_execute_callback,
        task_id='run_jobs_claim_op1',
    ...
    _submit_params = {
        ...
        "job_config": {
            "job_type": "spark_python",
            "name": "{{ dag.dag_id }}_run_jobs_silver_raw_fideliscare_claims_to_pharmacy_etl_260820_b2ac_{{ ts_nodash }}",
            "python_file": "/Workspace/Shared/dev-utils/pipelines/main.py",
            "parameters": [
                "/Workspace/Shared/codespace/pipelines/bh_project_id=104/pipeline/pipeline_id=1630/silver_raw_fideliscare_claims_to_pharmacy_etl_260820_b2ac.json",
                "databricks",
                "/Workspace/Shared/dev-utils/schemas"
            ]
        },
        ...
        "flow_id": 743,
        "pipeline_id": "1630",
        "pipeline_name": "silver_raw_fideliscare_claims_to_pharmacy_etl_260820_b2ac",
        "airflow_connection_id": "databricks_default",
        "pipeline_key": "silver_raw_fideliscare_claims_to_pharmacy_etl_260820_b2ac",
        "bh_project_id": 104,
        "project_id": 104,
        "project_name": "bighammer",
        "compute_xcom_key": "return_value",
    ...
    run_jobs_silver_raw_fideliscare_claims_to_pharmacy_etl_260820_b2ac = PythonOperator(
        pre_execute=common_task.pre_execute_callback,
        task_id='run_jobs_silver_raw_fideliscare_claims_to_pharmacy_etl_260820_b2ac',
        python_callable=submit_job_to_cluster,
        params=_submit_params,
        on_success_callback=feed_control_callbacks.submit_job_success_callback,
        on_failure_callback=feed_control_callbacks.submit_job_failure_callback,
    ...
    create_compute >> run_jobs_claim_op1
    run_jobs_claim_op1 >> run_jobs_silver_raw_fideliscare_claims_to_pharmacy_etl_260820_b2ac
    create_compute >> run_jobs_silver_raw_fideliscare_claims_to_pharmacy_etl_260820_b2ac
    run_jobs_silver_raw_fideliscare_claims_to_pharmacy_etl_260820_b2ac >> run_jobs_cinqcare_member_file_8_21_25_582
