...
common_task = CommonTask(dag_id='fidelis_upstate_enrollment_test_bh_682_636', dag_params={})
lineage_task = LineageTask(dag_id='fidelis_upstate_enrollment_test_bh_682_636', dag_params={})
...
with DAG(
    dag_id='fidelis_upstate_enrollment_test_bh_682_636',
    ...
    start_flow_task = PythonOperator(
        ...
        params = {
            'flow_id': 636,
            'flow_name': 'fidelis_upstate_enrollment_test_bh_682',
            'flow_key': 'fidelis_upstate_enrollment_test_bh_682',
            'bh_project_id': 104,
    ...
    _submit_params = {
        ...
        "job_config": {
            ...
            "parameters": [
                "/Workspace/Shared/codespace/test/pipelines/bh_project_id=104/pipeline/pipeline_id=1176/fidelis_upstate_enrollment_test_bh.json",
                "databricks",
    ...
    _submit_params = {
        ...
        "job_config": {
            "job_type": "spark_python",
            "name": "{{ dag.dag_id }}_run_pipelines_silver_raw_fidelis_ny_bh_dedupe_to_members_load_260708_6e56_{{ ts_nodash }}",
            "python_file": "/Workspace/Shared/dev-utils/pipelines/main.py",
            "parameters": [
                "/Workspace/Shared/codespace/test/pipelines/bh_project_id=104/pipeline/pipeline_id=1177/silver_raw_fidelis_ny_bh_dedupe_to_members_load_260708_6e56.json",
                "databricks",
                "/Workspace/Shared/dev-utils/schemas"
            ]
        },
        ...
        "validate_inbound_task_id": "validate_inbound_files",
        "facts_source": "databricks",
        "pipeline_name": "silver_raw_fidelis_ny_bh_dedupe_to_members_load_260708_6e56",
        "compute_xcom_key": "return_value",
        "valid_files": "{{ task_instance.xcom_pull(task_ids='validate_inbound_files', key='valid_files') }}",
        "batch_id": "{{ task_instance.xcom_pull(task_ids='validate_inbound_files', key='batch_id') }}",
        "pool_enabled": True,
    ...
    run_pipelines_silver_raw_fidelis_ny_bh_dedupe_to_members_load_260708_6e56 = PythonOperator(
        pre_execute=common_task.pre_execute_callback,
        task_id='run_pipelines_silver_raw_fidelis_ny_bh_dedupe_to_members_load_260708_6e56',
        python_callable=submit_job_to_cluster,
        params=_submit_params,
        on_success_callback=feed_control_callbacks.submit_job_success_callback,
        on_failure_callback=feed_control_callbacks.submit_job_failure_callback,
    ...
    run_pipelines_fidelis_upstate_enrollment_test_bh >> run_pipelines_silver_raw_fidelis_ny_bh_dedupe_to_members_load_260708_6e56
    create_compute >> run_pipelines_silver_raw_fidelis_ny_bh_dedupe_to_members_load_260708_6e56
    run_pipelines_silver_raw_fidelis_ny_bh_dedupe_to_members_load_260708_6e56 >> archive_processed_files
