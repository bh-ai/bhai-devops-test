...
common_task = CommonTask(dag_id='enrollment_fidelis_downstate_478_553', dag_params={})
lineage_task = LineageTask(dag_id='enrollment_fidelis_downstate_478_553', dag_params={})
...
with DAG(
    dag_id='enrollment_fidelis_downstate_478_553',
    ...
    start_flow_task = PythonOperator(
        ...
        params = {
            'flow_id': 553,
            'flow_name': 'Enrollment_fidelis_downstate_478',
            'flow_key': 'enrollment_fidelis_downstate_478',
            'bh_project_id': 299,
    ...
    _submit_params = {
        ...
        "job_config": {
            ...
            "name": "{{ dag.dag_id }}_run_pipelines_enrollment_fidelis_downstate_{{ ts_nodash }}",
            "python_file": "/Workspace/Shared/dev-utils/pipelines/main.py",
            "parameters": [
                "/Workspace/Shared/codespace/test/pipelines/bh_project_id=299/pipeline/pipeline_id=935/enrollment_fidelis_downstate.json",
                "databricks",
    ...
    run_pipelines_enrollment_fidelis_downstate = PythonOperator(
        pre_execute=common_task.pre_execute_callback,
        task_id='run_pipelines_enrollment_fidelis_downstate',
    ...
    _submit_params = {
        ...
        "job_config": {
            "job_type": "spark_python",
            "name": "{{ dag.dag_id }}_run_pipelines_silver_raw_fidelis_downstate_member_dedupe_load_260601_d17c_{{ ts_nodash }}",
            "python_file": "/Workspace/Shared/dev-utils/pipelines/main.py",
            "parameters": [
                "/Workspace/Shared/codespace/test/pipelines/bh_project_id=299/pipeline/pipeline_id=939/silver_raw_fidelis_downstate_member_dedupe_load_260601_d17c.json",
                "databricks",
                "/Workspace/Shared/dev-utils/schemas"
            ]
        },
    ...
    run_pipelines_silver_raw_fidelis_downstate_member_dedupe_load_260601_d17c = PythonOperator(
        pre_execute=common_task.pre_execute_callback,
        task_id='run_pipelines_silver_raw_fidelis_downstate_member_dedupe_load_260601_d17c',
        python_callable=submit_job_to_cluster,
        params=_submit_params,
        on_success_callback=common_task.success_callback,
        on_failure_callback=common_task.failure_callback,
    ...
    create_compute >> run_pipelines_enrollment_fidelis_downstate
    run_pipelines_enrollment_fidelis_downstate >> run_pipelines_silver_raw_fidelis_downstate_member_dedupe_load_260601_d17c
    create_compute >> run_pipelines_silver_raw_fidelis_downstate_member_dedupe_load_260601_d17c
    run_pipelines_silver_raw_fidelis_downstate_member_dedupe_load_260601_d17c >> archive_processed_files
