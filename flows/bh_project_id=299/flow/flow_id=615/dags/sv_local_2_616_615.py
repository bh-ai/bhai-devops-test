...
common_task = CommonTask(dag_id='sv_local_2_616_615', dag_params={})
lineage_task = LineageTask(dag_id='sv_local_2_616_615', dag_params={})
...
with DAG(
    ...
    start_flow_task = PythonOperator(
        ...
        params = {
            'flow_id': 615,
            'flow_name': 'sv_local_2_616',
            'flow_key': 'sv_local_2_616',
            'bh_project_id': 299,
    ...
    run_pipelines_sv_local_2 = PythonOperator(
        pre_execute=common_task.pre_execute_callback,
        task_id='run_pipelines_sv_local_2',
    ...
    create_compute >> run_pipelines_sv_local_2
    run_pipelines_sv_local_2 >> run_pipelines_enrollment_fidelis_downstate_v4
