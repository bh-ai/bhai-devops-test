...
common_task = CommonTask(dag_id='fidelis_upstate_enrollment_test_bh_v3_669_630', dag_params={})
lineage_task = LineageTask(dag_id='fidelis_upstate_enrollment_test_bh_v3_669_630', dag_params={})
...
with DAG(
    dag_id='fidelis_upstate_enrollment_test_bh_v3_669_630',
    ...
    start_flow_task = PythonOperator(
        ...
        params = {
            'flow_id': 630,
            'flow_name': 'fidelis_upstate_enrollment_test_bh_v3_669',
            'flow_key': 'fidelis_upstate_enrollment_test_bh_v3_669',
            'bh_project_id': 299,
    ...
    _validate_params = {
        ...
        "min_files": 1,
        "max_files": None,
        "quarantine_prefix": "bhargs/1-Enrollment/1-Enrollment/fedelisny/Batch/rejected",
        ...
        "control_schema": None,
        "feed_name": "fidelis_upstate_enrollment_test_bh_v3"
    }
    ...
    _submit_params = {
        ...
        "job_config": {
            ...
            "name": "{{ dag.dag_id }}_run_pipelines_fidelis_upstate_enrollment_test_bh_v3_{{ ts_nodash }}",
            "python_file": "/Workspace/Shared/dev-utils/pipelines/main.py",
            "parameters": [
                "/Workspace/Shared/codespace/test/pipelines/bh_project_id=299/pipeline/pipeline_id=1161/fidelis_upstate_enrollment_test_bh_v3.json",
                "databricks",
        ...
        "pipeline_name": "fidelis_upstate_enrollment_test_bh_v3",
    ...
    run_pipelines_fidelis_upstate_enrollment_test_bh_v3 = PythonOperator(
        pre_execute=common_task.pre_execute_callback,
        task_id='run_pipelines_fidelis_upstate_enrollment_test_bh_v3',
    ...
    _submit_params = {
        ...
        "job_config": {
            "job_type": "spark_python",
            "name": "{{ dag.dag_id }}_run_pipelines_silver_raw_fidelis_ny_dedupe_to_members_load_260706_587b_{{ ts_nodash }}",
            "python_file": "/Workspace/Shared/dev-utils/pipelines/main.py",
            "parameters": [
                "/Workspace/Shared/codespace/test/pipelines/bh_project_id=299/pipeline/pipeline_id=1162/silver_raw_fidelis_ny_dedupe_to_members_load_260706_587b.json",
                "databricks",
                "/Workspace/Shared/dev-utils/schemas"
            ]
        },
        ...
        "validate_inbound_task_id": "validate_inbound_files",
        "facts_source": "databricks",
        "pipeline_name": "silver_raw_fidelis_ny_dedupe_to_members_load_260706_587b",
        "compute_xcom_key": "return_value",
        "valid_files": "{{ task_instance.xcom_pull(task_ids='validate_inbound_files', key='valid_files') }}",
        "batch_id": "{{ task_instance.xcom_pull(task_ids='validate_inbound_files', key='batch_id') }}"
    }
    run_pipelines_silver_raw_fidelis_ny_dedupe_to_members_load_260706_587b = PythonOperator(
        pre_execute=common_task.pre_execute_callback,
        task_id='run_pipelines_silver_raw_fidelis_ny_dedupe_to_members_load_260706_587b',
        python_callable=submit_job_to_cluster,
        params=_submit_params,
        on_success_callback=feed_control_callbacks.submit_job_success_callback,
        on_failure_callback=feed_control_callbacks.submit_job_failure_callback,
    ...
    create_compute >> run_pipelines_fidelis_upstate_enrollment_test_bh_v3
    run_pipelines_fidelis_upstate_enrollment_test_bh_v3 >> run_pipelines_silver_raw_fidelis_ny_dedupe_to_members_load_260706_587b
    create_compute >> run_pipelines_silver_raw_fidelis_ny_dedupe_to_members_load_260706_587b
    run_pipelines_silver_raw_fidelis_ny_dedupe_to_members_load_260706_587b >> archive_processed_files
