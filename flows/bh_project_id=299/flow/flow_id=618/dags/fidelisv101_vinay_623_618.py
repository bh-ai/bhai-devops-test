...
common_task = CommonTask(dag_id='fidelisv101_vinay_623_618', dag_params={})
lineage_task = LineageTask(dag_id='fidelisv101_vinay_623_618', dag_params={})
...
with DAG(
    dag_id='fidelisv101_vinay_623_618',
    ...
    start_flow_task = PythonOperator(
        ...
        params = {
            'flow_id': 618,
            'flow_name': 'fidelisv101_vinay_623',
            'flow_key': 'fidelisv101_vinay_623',
            'bh_project_id': 299,
    ...
    _submit_params = {
        ...
        "job_config": {
            ...
            "name": "{{ dag.dag_id }}_run_pipelines_fidelis_ny_ds_26june2026_623_{{ ts_nodash }}",
            "python_file": "/Workspace/Shared/dev-utils/pipelines/main.py",
            "parameters": [
                "/Workspace/Shared/codespace/test/pipelines/bh_project_id=299/pipeline/pipeline_id=1117/fidelis_ny_ds_26june2026_623.json",
                "databricks",
        ...
        "pipeline_name": "fidelis_ny_ds_26june2026_623",
    ...
    run_pipelines_fidelis_ny_ds_26june2026_623 = PythonOperator(
        pre_execute=common_task.pre_execute_callback,
        task_id='run_pipelines_fidelis_ny_ds_26june2026_623',
    ...
    _submit_params = {
        ...
        "job_config": {
            "job_type": "spark_python",
            "name": "{{ dag.dag_id }}_run_pipelines_silver_raw_fidelis_downstate_ny_dedupe_to_members_load_260626_d359_{{ ts_nodash }}",
            "python_file": "/Workspace/Shared/dev-utils/pipelines/main.py",
            "parameters": [
                "/Workspace/Shared/codespace/test/pipelines/bh_project_id=299/pipeline/pipeline_id=1118/silver_raw_fidelis_downstate_ny_dedupe_to_members_load_260626_d359.json",
                "databricks",
                "/Workspace/Shared/dev-utils/schemas"
            ]
        },
        ...
        "validate_inbound_task_id": "validate_inbound_files",
        "facts_source": "databricks",
        "pipeline_name": "silver_raw_fidelis_downstate_ny_dedupe_to_members_load_260626_d359",
        "compute_xcom_key": "return_value",
        "valid_files": "{{ task_instance.xcom_pull(task_ids='validate_inbound_files', key='valid_files') }}",
        "batch_id": "{{ task_instance.xcom_pull(task_ids='validate_inbound_files', key='batch_id') }}"
    }
    run_pipelines_silver_raw_fidelis_downstate_ny_dedupe_to_members_load_260626_d359 = PythonOperator(
        pre_execute=common_task.pre_execute_callback,
        task_id='run_pipelines_silver_raw_fidelis_downstate_ny_dedupe_to_members_load_260626_d359',
        python_callable=submit_job_to_cluster,
        params=_submit_params,
        on_success_callback=feed_control_callbacks.submit_job_success_callback,
        on_failure_callback=feed_control_callbacks.submit_job_failure_callback,
    ...
    create_compute >> run_pipelines_fidelis_ny_ds_26june2026_623
    run_pipelines_fidelis_ny_ds_26june2026_623 >> run_pipelines_silver_raw_fidelis_downstate_ny_dedupe_to_members_load_260626_d359
    create_compute >> run_pipelines_silver_raw_fidelis_downstate_ny_dedupe_to_members_load_260626_d359
    run_pipelines_silver_raw_fidelis_downstate_ny_dedupe_to_members_load_260626_d359 >> archive_processed_files
