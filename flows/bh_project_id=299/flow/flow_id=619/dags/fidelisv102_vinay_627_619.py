...
common_task = CommonTask(dag_id='fidelisv102_vinay_627_619', dag_params={})
lineage_task = LineageTask(dag_id='fidelisv102_vinay_627_619', dag_params={})
...
with DAG(
    dag_id='fidelisv102_vinay_627_619',
    ...
    start_flow_task = PythonOperator(
        ...
        params = {
            'flow_id': 619,
            'flow_name': 'fidelisv102_vinay_627',
            'flow_key': 'fidelisv102_vinay_627',
            'bh_project_id': 299,
    ...
    _submit_params = {
        ...
        "job_config": {
            ...
            "name": "{{ dag.dag_id }}_run_pipelines_fidelis_ny_ds_va_26june2026_627_{{ ts_nodash }}",
            "python_file": "/Workspace/Shared/dev-utils/pipelines/main.py",
            "parameters": [
                "/Workspace/Shared/codespace/test/pipelines/bh_project_id=299/pipeline/pipeline_id=1120/fidelis_ny_ds_va_26june2026_627.json",
                "databricks",
        ...
        "pipeline_name": "fidelis_ny_ds_va_26june2026_627",
    ...
    run_pipelines_fidelis_ny_ds_va_26june2026_627 = PythonOperator(
        pre_execute=common_task.pre_execute_callback,
        task_id='run_pipelines_fidelis_ny_ds_va_26june2026_627',
    ...
    _submit_params = {
        ...
        "job_config": {
            "job_type": "spark_python",
            "name": "{{ dag.dag_id }}_run_pipelines_silver_raw_fidelis_ny_downstate_dedupe_to_members_load_260626_dedc_{{ ts_nodash }}",
            "python_file": "/Workspace/Shared/dev-utils/pipelines/main.py",
            "parameters": [
                "/Workspace/Shared/codespace/test/pipelines/bh_project_id=299/pipeline/pipeline_id=1121/silver_raw_fidelis_ny_downstate_dedupe_to_members_load_260626_dedc.json",
                "databricks",
                "/Workspace/Shared/dev-utils/schemas"
            ]
        },
        ...
        "validate_inbound_task_id": "validate_inbound_files",
        "facts_source": "databricks",
        "pipeline_name": "silver_raw_fidelis_ny_downstate_dedupe_to_members_load_260626_dedc",
        "compute_xcom_key": "return_value",
        "valid_files": "{{ task_instance.xcom_pull(task_ids='validate_inbound_files', key='valid_files') }}",
        "batch_id": "{{ task_instance.xcom_pull(task_ids='validate_inbound_files', key='batch_id') }}"
    }
    run_pipelines_silver_raw_fidelis_ny_downstate_dedupe_to_members_load_260626_dedc = PythonOperator(
        pre_execute=common_task.pre_execute_callback,
        task_id='run_pipelines_silver_raw_fidelis_ny_downstate_dedupe_to_members_load_260626_dedc',
        python_callable=submit_job_to_cluster,
        params=_submit_params,
        on_success_callback=feed_control_callbacks.submit_job_success_callback,
        on_failure_callback=feed_control_callbacks.submit_job_failure_callback,
    ...
    create_compute >> run_pipelines_fidelis_ny_ds_va_26june2026_627
    run_pipelines_fidelis_ny_ds_va_26june2026_627 >> run_pipelines_silver_raw_fidelis_ny_downstate_dedupe_to_members_load_260626_dedc
    create_compute >> run_pipelines_silver_raw_fidelis_ny_downstate_dedupe_to_members_load_260626_dedc
    run_pipelines_silver_raw_fidelis_ny_downstate_dedupe_to_members_load_260626_dedc >> archive_processed_files
