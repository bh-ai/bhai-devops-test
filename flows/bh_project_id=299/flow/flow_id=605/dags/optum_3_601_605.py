...
common_task = CommonTask(dag_id='optum_3_601_605', dag_params={})
lineage_task = LineageTask(dag_id='optum_3_601_605', dag_params={})
...
with DAG(
    ...
    start_flow_task = PythonOperator(
        ...
        params = {
            'flow_id': 605,
            'flow_name': 'optum_3_601',
            'flow_key': 'optum_3_601',
            'bh_project_id': 299,
    ...
    _submit_params = {
        ...
        "job_config": {
            ...
            "name": "{{ dag.dag_id }}_run_pipelines_optum_3_{{ ts_nodash }}",
            "python_file": "/Workspace/Shared/dev-utils/pipelines/main.py",
            "parameters": [
                "/Workspace/Shared/codespace/test/pipelines/bh_project_id=299/pipeline/pipeline_id=1098/optum_3.json",
                "databricks",
    ...
    run_pipelines_optum_3 = PythonOperator(
        pre_execute=common_task.pre_execute_callback,
        task_id='run_pipelines_optum_3',
    ...
    create_compute >> run_pipelines_optum_3
    run_pipelines_optum_3 >> archive_processed_files
