...
common_task = CommonTask(dag_id='sv_enroll_19may_1_369', dag_params={})
lineage_task = LineageTask(dag_id='sv_enroll_19may_1_369', dag_params={})
...
with DAG(
    ...
    start_flow_task = PythonOperator(
        ...
        params = {
            'flow_id': 498,
            'flow_name': 'sv_enroll_19may_1_369',
    ...
    _submit_params = {
        ...
        "job_config": {
            ...
            "name": "{{ dag.dag_id }}_run_pipelines_sv_enroll_19may_1_{{ ts_nodash }}",
            "python_file": "/Workspace/Shared/dev-utils/pipelines/main.py",
            "parameters": [
                "/Workspace/Shared/codespace/test/pipelines/bh_project_id=299/pipeline/pipeline_id=764/sv_enroll_19may_1.json",
                "databricks",
    ...
    run_pipelines_sv_enroll_19may_1 = PythonOperator(
        pre_execute=common_task.pre_execute_callback,
        task_id='run_pipelines_sv_enroll_19may_1',
    ...
    _submit_params = {
        ...
        "job_config": {
            "job_type": "spark_python",
            "name": "{{ dag.dag_id }}_run_pipelines_silver_raw_fidelis_ny_upstate_to_members_load_260519_7ec7_{{ ts_nodash }}",
            "python_file": "/Workspace/Shared/dev-utils/pipelines/main.py",
            "parameters": [
                "/Workspace/Shared/codespace/test/pipelines/bh_project_id=299/pipeline/pipeline_id=765/silver_raw_fidelis_ny_upstate_to_members_load_260519_7ec7.json",
                "databricks",
                "/Workspace/Shared/dev-utils/schemas"
            ]
        },
    ...
    run_pipelines_silver_raw_fidelis_ny_upstate_to_members_load_260519_7ec7 = PythonOperator(
        pre_execute=common_task.pre_execute_callback,
        task_id='run_pipelines_silver_raw_fidelis_ny_upstate_to_members_load_260519_7ec7',
        python_callable=submit_job_to_cluster,
        params=_submit_params,
        on_success_callback=common_task.success_callback,
        on_failure_callback=common_task.failure_callback,
    ...
    create_compute >> run_pipelines_sv_enroll_19may_1
    run_pipelines_sv_enroll_19may_1 >> run_pipelines_silver_raw_fidelis_ny_upstate_to_members_load_260519_7ec7
    create_compute >> run_pipelines_silver_raw_fidelis_ny_upstate_to_members_load_260519_7ec7
    run_pipelines_silver_raw_fidelis_ny_upstate_to_members_load_260519_7ec7 >> archive_processed_files
