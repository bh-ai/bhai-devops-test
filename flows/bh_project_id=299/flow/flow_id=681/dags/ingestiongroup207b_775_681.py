...
common_task = CommonTask(dag_id='ingestiongroup207b_775_681', dag_params={})
lineage_task = LineageTask(dag_id='ingestiongroup207b_775_681', dag_params={})
...
with DAG(
    dag_id='ingestiongroup207b_775_681',
    ...
    start_flow_task = PythonOperator(
        ...
        params = {
            'flow_id': 681,
            'flow_name': 'ingestiongroup207b_775',
            'flow_key': 'ingestiongroup207b_775',
            'bh_project_id': 299,
    ...
    _validate_params = {
        ...
        "control_schema": None,
        "feed_name": "ingestiongroup207b",
        "feed_id": "ingestiongroup207b"
    }
    ...
    _submit_params = {
        ...
        "pipeline_name": "ingestiongroup207b",
        "airflow_connection_id": "databricks_default",
        "pipeline_key": "ingestiongroup207b",
    ...
    run_pipelines_ingestiongroup207b = PythonOperator(
        pre_execute=common_task.pre_execute_callback,
        task_id='run_pipelines_ingestiongroup207b',
    ...
    _submit_params = {
        ...
        "validate_inbound_task_id": "validate_inbound_files",
        "facts_source": "databricks",
        "pipeline_name": "silver_raw_safeharbor_to_members_dedupe_load_260720_9ebb",
        "airflow_connection_id": "databricks_default",
        "pipeline_key": "silver_raw_safeharbor_to_members_dedupe_load_260720_9ebb",
        "compute_xcom_key": "return_value",
        "valid_files": "{{ task_instance.xcom_pull(task_ids='validate_inbound_files', key='valid_files') }}",
        "batch_id": "{{ task_instance.xcom_pull(task_ids='validate_inbound_files', key='batch_id') }}"
    }
    run_pipelines_silver_raw_safeharbor_to_members_dedupe_load_260720_9ebb = PythonOperator(
        pre_execute=common_task.pre_execute_callback,
        task_id='run_pipelines_silver_raw_safeharbor_to_members_dedupe_load_260720_9ebb',
        python_callable=submit_job_to_cluster,
        params=_submit_params,
        on_success_callback=feed_control_callbacks.submit_job_success_callback,
        on_failure_callback=feed_control_callbacks.submit_job_failure_callback,
    ...
    create_compute >> run_pipelines_ingestiongroup207b
    run_pipelines_ingestiongroup207b >> run_pipelines_silver_raw_safeharbor_to_members_dedupe_load_260720_9ebb
    create_compute >> run_pipelines_silver_raw_safeharbor_to_members_dedupe_load_260720_9ebb
    run_pipelines_silver_raw_safeharbor_to_members_dedupe_load_260720_9ebb >> archive_processed_files
