...
common_task = CommonTask(dag_id='enrollment_uhc_v1_769_680', dag_params={})
lineage_task = LineageTask(dag_id='enrollment_uhc_v1_769_680', dag_params={})
...
with DAG(
    dag_id='enrollment_uhc_v1_769_680',
    ...
    start_flow_task = PythonOperator(
        ...
        params = {
            'flow_id': 680,
            'flow_name': 'enrollment_uhc_v1_769',
            'flow_key': 'enrollment_uhc_v1_769',
            'bh_project_id': 299,
    ...
    _validate_params = {
        ...
        "source_prefix": "bhargs/1-Enrollment/1-Enrollment/UHC/Batch",
        ...
        "min_files": 1,
        "max_files": None,
        "quarantine_prefix": "bhargs/1-Enrollment/1-Enrollment/UHC/Batch/rejected",
        "fail_on_invalid": True,
        "sources": [
            {
                "source_name": "safehabour_uhc_md_20260430",
                "prefix": "bhargs/1-Enrollment/1-Enrollment/UHC/Batch",
                "filename_regex": "safehabour_uhc_md_.*.csv",
        ...
        "control_schema": None,
        "feed_name": "enrollment_uhc_v1",
        "feed_id": "enrollment_uhc_v1"
    }
    ...
    _submit_params = {
        ...
        "pipeline_name": "enrollment_uhc_v1",
        "airflow_connection_id": "databricks_default",
        "pipeline_key": "enrollment_uhc_v1",
    ...
    run_pipelines_enrollment_uhc_v1 = PythonOperator(
        pre_execute=common_task.pre_execute_callback,
        task_id='run_pipelines_enrollment_uhc_v1',
    ...
    _submit_params = {
        ...
        "validate_inbound_task_id": "validate_inbound_files",
        "facts_source": "databricks",
        "pipeline_name": "silver_raw_uhc_roster_to_members_load_260717_f1dc",
        "airflow_connection_id": "databricks_default",
        "pipeline_key": "silver_raw_uhc_roster_to_members_load_260717_f1dc",
        "compute_xcom_key": "return_value",
        "valid_files": "{{ task_instance.xcom_pull(task_ids='validate_inbound_files', key='valid_files') }}",
        "batch_id": "{{ task_instance.xcom_pull(task_ids='validate_inbound_files', key='batch_id') }}",
        "pool_enabled": True,
    ...
    run_pipelines_silver_raw_uhc_roster_to_members_load_260717_f1dc = PythonOperator(
        pre_execute=common_task.pre_execute_callback,
        task_id='run_pipelines_silver_raw_uhc_roster_to_members_load_260717_f1dc',
        python_callable=submit_job_to_cluster,
        params=_submit_params,
        on_success_callback=feed_control_callbacks.submit_job_success_callback,
        on_failure_callback=feed_control_callbacks.submit_job_failure_callback,
    ...
    _archive_params = {
        "bucket_name": "my-test-bucket",
        "source_prefix": "",
        "archive_prefix": "Archive/bhargs/1-Enrollment/1-Enrollment/UHC/Batch",
        "cloud_type": "databricks",
        "airflow_connection_id": "databricks_default",
        "secret_name": "bh-dev-westus3-kv-key-scope/bh-azureblob-azureblob",
        "delete_source": True,
    ...
    create_compute >> run_pipelines_enrollment_uhc_v1
    run_pipelines_enrollment_uhc_v1 >> run_pipelines_silver_raw_uhc_roster_to_members_load_260717_f1dc
    create_compute >> run_pipelines_silver_raw_uhc_roster_to_members_load_260717_f1dc
    run_pipelines_silver_raw_uhc_roster_to_members_load_260717_f1dc >> archive_processed_files
