...
with DAG(
    ...
    pipeline_json_path = "/pipelines/bh_project_id=299/pipeline/pipeline_id=844/spark-job-pipeline.json"
    ...
    spark_app_yaml_spark_operator_533488277 = f'''
    ...
    spec:
      ...
      pythonVersion: "3"
      mode: cluster
      image: "bhdwestus3acr01.azurecr.io/bh-transformation-utils-gluten/pyspark_slim:1.0.0-98-rc"
