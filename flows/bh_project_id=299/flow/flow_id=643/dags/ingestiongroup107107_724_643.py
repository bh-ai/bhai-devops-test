...
common_task = CommonTask(dag_id='ingestiongroup107107_724_643', dag_params={})
lineage_task = LineageTask(dag_id='ingestiongroup107107_724_643', dag_params={})
...
with DAG(
    dag_id='ingestiongroup107107_724_643',
    ...
    start_flow_task = PythonOperator(
        ...
        params = {
            'flow_id': 643,
            'flow_name': 'ingestiongroup107107_724',
            'flow_key': 'ingestiongroup107107_724',
            'bh_project_id': 299,
    ...
    _validate_params = {
        ...
        "control_schema": None,
        "feed_name": "ingestiongroup107107",
        "feed_id": "ingestiongroup107107"
    }
    ...
    _submit_params = {
        ...
        "pipeline_name": "ingestiongroup107107",
    ...
    run_pipelines_ingestiongroup107107 = PythonOperator(
        pre_execute=common_task.pre_execute_callback,
        task_id='run_pipelines_ingestiongroup107107',
    ...
    _submit_params = {
        ...
        "validate_inbound_task_id": "validate_inbound_files",
        "facts_source": "databricks",
        "pipeline_name": "silver_raw_member_data_parsing_and_mapping_260710_6f84",
        "compute_xcom_key": "return_value",
        "valid_files": "{{ task_instance.xcom_pull(task_ids='validate_inbound_files', key='valid_files') }}",
        "batch_id": "{{ task_instance.xcom_pull(task_ids='validate_inbound_files', key='batch_id') }}"
    }
    run_pipelines_silver_raw_member_data_parsing_and_mapping_260710_6f84 = PythonOperator(
        pre_execute=common_task.pre_execute_callback,
        task_id='run_pipelines_silver_raw_member_data_parsing_and_mapping_260710_6f84',
        python_callable=submit_job_to_cluster,
        params=_submit_params,
        on_success_callback=feed_control_callbacks.submit_job_success_callback,
        on_failure_callback=feed_control_callbacks.submit_job_failure_callback,
    ...
    create_compute >> run_pipelines_ingestiongroup107107
    run_pipelines_ingestiongroup107107 >> run_pipelines_silver_raw_member_data_parsing_and_mapping_260710_6f84
    create_compute >> run_pipelines_silver_raw_member_data_parsing_and_mapping_260710_6f84
    run_pipelines_silver_raw_member_data_parsing_and_mapping_260710_6f84 >> archive_processed_files
