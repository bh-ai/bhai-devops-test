...
common_task = CommonTask(dag_id='sv_local_7_980_769', dag_params={})
lineage_task = LineageTask(dag_id='sv_local_7_980_769', dag_params={})
...
with DAG(
    ...
    start_flow_task = PythonOperator(
        ...
        params = {
            'flow_id': 769,
            'flow_name': 'sv_local_7_980',
            'flow_key': 'sv_local_7_980',
            'bh_project_id': 299,
    ...
    _validate_params = {
        ...
        "min_files": 1,
        "max_files": None,
        "quarantine_prefix": "smaller_data/rejected",
        ...
        "sources": [
            ...
            {
                "source_name": "legacyauditlogcr",
                "prefix": "smaller_data",
                "filename_regex": "^legacy_audit_log_cr[.]txt$",
                "ignore_subfolders": True,
                "is_required": True,
                "min_bytes": 10,
                "min_files": 1
            ...
            {
                "source_name": "muthusheet",
                "prefix": "smaller_data",
                "filename_regex": "^muthu\\(Sheet[0-9]{1}\\)[.]csv$",
                "ignore_subfolders": True,
                "is_required": True,
                "min_bytes": 10,
                "min_files": 1
            ...
            {
                "source_name": "unixstagingconfiglf",
                "prefix": "smaller_data",
                "filename_regex": "^unix_staging_config_lf[.]env$",
                "ignore_subfolders": True,
                "is_required": True,
                "min_bytes": 10,
                "min_files": 1
            ...
            {
                "source_name": "windowsorderscrlf",
                "prefix": "smaller_data",
                "filename_regex": "^windows_orders_crlf[.]csv$",
                "ignore_subfolders": True,
                "is_required": True,
                "min_bytes": 10,
                "min_files": 1
    ...
    _submit_params = {
        ...
        "job_config": {
            ...
            "name": "{{ dag.dag_id }}_run_pipelines_sv_local_7_{{ ts_nodash }}",
            "python_file": "/Workspace/Shared/dev-utils/pipelines/main.py",
            "parameters": [
                "/Workspace/Shared/codespace/pipelines/bh_project_id=299/pipeline/pipeline_id=1905/sv_local_7.json",
                "databricks",
        ...
        "pipeline_name": "sv_local_7",
        "run_data_quality_rules": False,
        "dq_rules_source": "git",
        "airflow_connection_id": "databricks_default",
        "pipeline_key": "sv_local_7",
        "bh_project_id": 299,
        "project_id": 299,
        "project_name": "flow-test-project",
    ...
    run_pipelines_sv_local_7 = PythonOperator(
        pre_execute=common_task.pre_execute_callback,
        task_id='run_pipelines_sv_local_7',
    ...
    _archive_params = {
        "bucket_name": "my-test-bucket",
        "source_prefix": "",
        "archive_prefix": "Archive/smaller_data",
        "cloud_type": "databricks",
        "airflow_connection_id": "databricks_default",
        "secret_name": "bh-dev-westus3-kv-key-scope/bh-azureblob-azureblob",
        "delete_source": True,
    ...
    create_compute >> run_pipelines_sv_local_7
    run_pipelines_sv_local_7 >> archive_processed_files
