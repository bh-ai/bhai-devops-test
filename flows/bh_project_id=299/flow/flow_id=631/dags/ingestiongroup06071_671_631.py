...
common_task = CommonTask(dag_id='ingestiongroup06071_671_631', dag_params={})
lineage_task = LineageTask(dag_id='ingestiongroup06071_671_631', dag_params={})
...
with DAG(
    dag_id='ingestiongroup06071_671_631',
    ...
    start_flow_task = PythonOperator(
        ...
        params = {
            'flow_id': 631,
            'flow_name': 'ingestiongroup06071_671',
            'flow_key': 'ingestiongroup06071_671',
            'bh_project_id': 299,
    ...
    _validate_params = {
        ...
        "min_files": 1,
        "max_files": None,
        "quarantine_prefix": "bhargs/1-Enrollment/1-Enrollment/fedelisny/rejected",
    ...
    _submit_params = {
        ...
        "job_config": {
            ...
            "name": "{{ dag.dag_id }}_run_pipelines_ingestiongroup06071_{{ ts_nodash }}",
            "python_file": "/Workspace/Shared/dev-utils/pipelines/main.py",
            "parameters": [
                "/Workspace/Shared/codespace/test/pipelines/bh_project_id=299/pipeline/pipeline_id=1163/ingestiongroup06071.json",
                "databricks",
        ...
        "pipeline_name": "ingestiongroup06071",
    ...
    run_pipelines_ingestiongroup06071 = PythonOperator(
        pre_execute=common_task.pre_execute_callback,
        task_id='run_pipelines_ingestiongroup06071',
    ...
    _submit_params = {
        ...
        "job_config": {
            "job_type": "spark_python",
            "name": "{{ dag.dag_id }}_run_pipelines_silver_raw_safeharbor_to_members_dedupe_load_260706_d403_{{ ts_nodash }}",
            "python_file": "/Workspace/Shared/dev-utils/pipelines/main.py",
            "parameters": [
                "/Workspace/Shared/codespace/test/pipelines/bh_project_id=299/pipeline/pipeline_id=1164/silver_raw_safeharbor_to_members_dedupe_load_260706_d403.json",
                "databricks",
                "/Workspace/Shared/dev-utils/schemas"
            ]
        },
        ...
        "validate_inbound_task_id": "validate_inbound_files",
        "facts_source": "databricks",
        "pipeline_name": "silver_raw_safeharbor_to_members_dedupe_load_260706_d403",
        "compute_xcom_key": "return_value",
        "valid_files": "{{ task_instance.xcom_pull(task_ids='validate_inbound_files', key='valid_files') }}",
        "batch_id": "{{ task_instance.xcom_pull(task_ids='validate_inbound_files', key='batch_id') }}"
    }
    run_pipelines_silver_raw_safeharbor_to_members_dedupe_load_260706_d403 = PythonOperator(
        pre_execute=common_task.pre_execute_callback,
        task_id='run_pipelines_silver_raw_safeharbor_to_members_dedupe_load_260706_d403',
        python_callable=submit_job_to_cluster,
        params=_submit_params,
        on_success_callback=feed_control_callbacks.submit_job_success_callback,
        on_failure_callback=feed_control_callbacks.submit_job_failure_callback,
    ...
    create_compute >> run_pipelines_ingestiongroup06071
    run_pipelines_ingestiongroup06071 >> run_pipelines_silver_raw_safeharbor_to_members_dedupe_load_260706_d403
    create_compute >> run_pipelines_silver_raw_safeharbor_to_members_dedupe_load_260706_d403
    run_pipelines_silver_raw_safeharbor_to_members_dedupe_load_260706_d403 >> archive_processed_files
