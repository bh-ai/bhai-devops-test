...
common_task = CommonTask(dag_id='ingestiongroup2632_630_620', dag_params={})
lineage_task = LineageTask(dag_id='ingestiongroup2632_630_620', dag_params={})
...
with DAG(
    ...
    start_flow_task = PythonOperator(
        ...
        params = {
            'flow_id': 620,
            'flow_name': 'ingestiongroup2632_630',
            'flow_key': 'ingestiongroup2632_630',
            'bh_project_id': 299,
    ...
    _validate_params = {
        ...
        "min_files": 1,
        "max_files": None,
        "quarantine_prefix": "bhargs/1-Enrollment/1-Enrollment/optum/rejected",
        "fail_on_invalid": True,
        "sources": [
            {
                "source_name": "safeharbor_cinqcare_elig_202604_n",
                "prefix": "bhargs/1-Enrollment/1-Enrollment/optum",
                "filename_regex": "safeharbor_CINQCare_Elig_202604-n.csv",
    ...
    _submit_params = {
        ...
        "pipeline_name": "ingestiongroup2632",
    ...
    run_pipelines_ingestiongroup2632 = PythonOperator(
        pre_execute=common_task.pre_execute_callback,
        task_id='run_pipelines_ingestiongroup2632',
    ...
    _submit_params = {
        ...
        "validate_inbound_task_id": "validate_inbound_files",
        "facts_source": "databricks",
        "pipeline_name": "silver_raw_cinqcare_elig_to_members_orders_load_260626_ba9c",
        "compute_xcom_key": "return_value",
        "valid_files": "{{ task_instance.xcom_pull(task_ids='validate_inbound_files', key='valid_files') }}",
        "batch_id": "{{ task_instance.xcom_pull(task_ids='validate_inbound_files', key='batch_id') }}"
    }
    run_pipelines_silver_raw_cinqcare_elig_to_members_orders_load_260626_ba9c = PythonOperator(
        pre_execute=common_task.pre_execute_callback,
        task_id='run_pipelines_silver_raw_cinqcare_elig_to_members_orders_load_260626_ba9c',
        python_callable=submit_job_to_cluster,
        params=_submit_params,
        on_success_callback=feed_control_callbacks.submit_job_success_callback,
        on_failure_callback=feed_control_callbacks.submit_job_failure_callback,
    ...
    create_compute >> run_pipelines_ingestiongroup2632
    run_pipelines_ingestiongroup2632 >> run_pipelines_silver_raw_cinqcare_elig_to_members_orders_load_260626_ba9c
    create_compute >> run_pipelines_silver_raw_cinqcare_elig_to_members_orders_load_260626_ba9c
    run_pipelines_silver_raw_cinqcare_elig_to_members_orders_load_260626_ba9c >> archive_processed_files
