...
common_task = CommonTask(dag_id='ingestiongroup161_580_590', dag_params={})
lineage_task = LineageTask(dag_id='ingestiongroup161_580_590', dag_params={})
...
with DAG(
    dag_id='ingestiongroup161_580_590',
    ...
    start_flow_task = PythonOperator(
        ...
        params = {
            'flow_id': 590,
            'flow_name': 'Ingestiongroup161_580',
            'flow_key': 'ingestiongroup161_580',
            'bh_project_id': 299,
    ...
    _validate_params = {
        ...
        "source_prefix": "bhargs/1-Enrollment/1-Enrollment/fedelisny",
        ...
        "sources": [
            {
                ...
                "filename_regex": "^safeharbor_CINQDOWNSTATE_Member_Roster_[0-9]{2}_[0-9]{2}_[0-9]{4} \\([0-9]{1}\\)[.]xlsx$",
    ...
    _submit_params = {
        ...
        "pipeline_name": "Ingestiongroup161",
    ...
    run_pipelines_ingestiongroup161 = PythonOperator(
        pre_execute=common_task.pre_execute_callback,
        task_id='run_pipelines_ingestiongroup161',
    ...
    _submit_params = {
        ...
        "validate_inbound_task_id": "validate_inbound_files",
        "facts_source": "databricks",
        "pipeline_name": "silver_raw_fidelis_ny_downstate_enrollment_to_members_dedupe_load_260616_b5eb",
        "compute_xcom_key": "return_value",
        "valid_files": "{{ task_instance.xcom_pull(task_ids='validate_inbound_files', key='valid_files') }}",
        "batch_id": "{{ task_instance.xcom_pull(task_ids='validate_inbound_files', key='batch_id') }}"
    }
    run_pipelines_silver_raw_fidelis_ny_downstate_enrollment_to_members_dedupe_load_260616_b5eb = PythonOperator(
        pre_execute=common_task.pre_execute_callback,
        task_id='run_pipelines_silver_raw_fidelis_ny_downstate_enrollment_to_members_dedupe_load_260616_b5eb',
        python_callable=submit_job_to_cluster,
        params=_submit_params,
        on_success_callback=feed_control_callbacks.submit_job_success_callback,
        on_failure_callback=feed_control_callbacks.submit_job_failure_callback,
    ...
    _archive_params = {
        "bucket_name": "my-test-bucket",
        "source_prefix": "",
        "archive_prefix": "Archive/bhargs/1-Enrollment/1-Enrollment/fedelisny",
        "cloud_type": "databricks",
        "airflow_connection_id": "databricks_default",
        "secret_name": "bh-dev-westus3-kv-key-scope/bh-azureblob-azureblob",
        "delete_source": True,
    ...
    create_compute >> run_pipelines_ingestiongroup161
    run_pipelines_ingestiongroup161 >> run_pipelines_silver_raw_fidelis_ny_downstate_enrollment_to_members_dedupe_load_260616_b5eb
    create_compute >> run_pipelines_silver_raw_fidelis_ny_downstate_enrollment_to_members_dedupe_load_260616_b5eb
    run_pipelines_silver_raw_fidelis_ny_downstate_enrollment_to_members_dedupe_load_260616_b5eb >> archive_processed_files
