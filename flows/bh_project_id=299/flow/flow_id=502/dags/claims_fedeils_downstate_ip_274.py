...
common_task = CommonTask(dag_id='claims_fedeils_downstate_ip_274', dag_params={})
lineage_task = LineageTask(dag_id='claims_fedeils_downstate_ip_274', dag_params={})
...
with DAG(
    dag_id='claims_fedeils_downstate_ip_274',
    ...
    start_flow_task = PythonOperator(
        ...
        params = {
            'flow_id': 502,
            'flow_name': 'claims_fedeils_downstate_ip_274',
            'flow_key': 'claims_fedeils_downstate_ip_274',
            'bh_project_id': 299,
    ...
    _validate_params = {
        ...
        "source_prefix": "bhargs/3-Claims/3-Claims/Fidelis/Downstate/IP",
        ...
        "sources": [
            {
                "source_name": "Fideliscare_ip_claim_header_downstate",
                "prefix": "bhargs/3-Claims/3-Claims/Fidelis/Downstate/IP/"
            },
            {
                "source_name": "Fideliscare_ip_claim_line_downstate",
                "prefix": "bhargs/3-Claims/3-Claims/Fidelis/Downstate/IP/"
            }
        ]
    }
        ...
        payload = (
            {
                ...
                "custom_tags": {},
                "init_scripts": [
                    "/Workspace/Shared/dev-utils/scripts/bh_test_databricks_grpc_server_codeartifact.sh"
                ],
                "libraries": [],
    ...
    _submit_params = {
        ...
        "job_config": {
            ...
            "name": "{{ dag.dag_id }}_run_pipelines_claims_fedeils_downstate_ip_{{ ts_nodash }}",
            "python_file": "/Workspace/Shared/dev-utils/pipelines/main.py",
            "parameters": [
                "/Workspace/Shared/codespace/test/pipelines/bh_project_id=299/pipeline/pipeline_id=776/claims_fedeils_downstate_ip.json",
                "databricks",
    ...
    run_pipelines_claims_fedeils_downstate_ip = PythonOperator(
        pre_execute=common_task.pre_execute_callback,
        task_id='run_pipelines_claims_fedeils_downstate_ip',
    ...
    _submit_params = {
        ...
        "job_config": {
            "job_type": "spark_python",
            "name": "{{ dag.dag_id }}_run_pipelines_fideliscare_ip_claim_header_downstate_274_{{ ts_nodash }}",
            "python_file": "/Workspace/Shared/dev-utils/pipelines/main.py",
            "parameters": [
                "/Workspace/Shared/codespace/test/pipelines/bh_project_id=299/pipeline/pipeline_id=697/fideliscare_ip_claim_header_downstate_274.json",
                "databricks",
                "/Workspace/Shared/dev-utils/schemas"
            ]
        },
    ...
    run_pipelines_fideliscare_ip_claim_header_downstate_274 = PythonOperator(
        pre_execute=common_task.pre_execute_callback,
        task_id='run_pipelines_fideliscare_ip_claim_header_downstate_274',
        python_callable=submit_job_to_cluster,
        params=_submit_params,
        on_success_callback=common_task.success_callback,
        on_failure_callback=common_task.failure_callback,
    ...
    _submit_params = {
        ...
        "job_config": {
            "job_type": "spark_python",
            "name": "{{ dag.dag_id }}_run_pipelines_fideliscare_ip_claim_line_downstate_274_{{ ts_nodash }}",
            "python_file": "/Workspace/Shared/dev-utils/pipelines/main.py",
            "parameters": [
                "/Workspace/Shared/codespace/test/pipelines/bh_project_id=299/pipeline/pipeline_id=698/fideliscare_ip_claim_line_downstate_274.json",
                "databricks",
                "/Workspace/Shared/dev-utils/schemas"
            ]
        },
    ...
    run_pipelines_fideliscare_ip_claim_line_downstate_274 = PythonOperator(
        pre_execute=common_task.pre_execute_callback,
        task_id='run_pipelines_fideliscare_ip_claim_line_downstate_274',
        python_callable=submit_job_to_cluster,
        params=_submit_params,
        on_success_callback=common_task.success_callback,
        on_failure_callback=common_task.failure_callback,
    ...
    _submit_params = {
        ...
        "job_config": {
            "job_type": "spark_python",
            "name": "{{ dag.dag_id }}_run_pipelines_silver_raw_fidelis_ip_claims_to_cinqcare_silver_260511_8f17_{{ ts_nodash }}",
            "python_file": "/Workspace/Shared/dev-utils/pipelines/main.py",
            "parameters": [
                "/Workspace/Shared/codespace/test/pipelines/bh_project_id=299/pipeline/pipeline_id=699/silver_raw_fidelis_ip_claims_to_cinqcare_silver_260511_8f17.json",
                "databricks",
                "/Workspace/Shared/dev-utils/schemas"
            ]
        },
    ...
    run_pipelines_silver_raw_fidelis_ip_claims_to_cinqcare_silver_260511_8f17 = PythonOperator(
        pre_execute=common_task.pre_execute_callback,
        task_id='run_pipelines_silver_raw_fidelis_ip_claims_to_cinqcare_silver_260511_8f17',
        python_callable=submit_job_to_cluster,
        params=_submit_params,
        on_success_callback=common_task.success_callback,
        on_failure_callback=common_task.failure_callback,
    ...
    _archive_params = {
        "bucket_name": "my-test-bucket",
        "source_prefix": "",
        "archive_prefix": "Archive/bhargs/3-Claims/3-Claims/Fidelis/Downstate/IP",
        "cloud_type": "databricks",
        "airflow_connection_id": "databricks_default",
        "secret_name": "bh-dev-westus3-kv-key-scope/bh-azureblob-azureblob",
        "delete_source": True,
    ...
    create_compute >> run_pipelines_claims_fedeils_downstate_ip
    run_pipelines_claims_fedeils_downstate_ip >> run_pipelines_fideliscare_ip_claim_header_downstate_274
    create_compute >> run_pipelines_fideliscare_ip_claim_header_downstate_274
    run_pipelines_fideliscare_ip_claim_header_downstate_274 >> run_pipelines_fideliscare_ip_claim_line_downstate_274
    create_compute >> run_pipelines_fideliscare_ip_claim_line_downstate_274
    run_pipelines_fideliscare_ip_claim_line_downstate_274 >> run_pipelines_silver_raw_fidelis_ip_claims_to_cinqcare_silver_260511_8f17
    create_compute >> run_pipelines_silver_raw_fidelis_ip_claims_to_cinqcare_silver_260511_8f17
    run_pipelines_silver_raw_fidelis_ip_claims_to_cinqcare_silver_260511_8f17 >> archive_processed_files
