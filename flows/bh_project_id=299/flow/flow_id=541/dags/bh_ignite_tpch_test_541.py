...
common_task = CommonTask(dag_id='bh_ignite_tpch_test_541', dag_params={})
lineage_task = LineageTask(dag_id='bh_ignite_tpch_test_541', dag_params={})
...
with DAG(
    dag_id='bh_ignite_tpch_test_541',
    ...
    start_flow_task = PythonOperator(
        ...
        params = {
            'flow_id': 541,
            'flow_name': 'bh-ignite-tpch-test',
            'flow_key': 'bh_ignite_tpch_test',
            'bh_project_id': 299,
    ...
    spark_app_yaml_bh_ignite_ddb45dba2 = f'''
    apiVersion: "sparkoperator.k8s.io/v1beta2"
    kind: SparkApplication
    metadata:
      name: "spark-app-bh-ignite-ddb45dba2"
      namespace: "spark-operator"
    spec:
      type: Python
      pythonVersion: "3"
      mode: cluster
      image: "bhdwestus3acr01.azurecr.io/bh-transformation-utils-gluten/pyspark_slim:1.0.0-109-rc"
    ...
    bh_ignite_ddb45dba2 = SparkKubernetesOperator(
        task_id='bh_ignite_ddb45dba2',
        namespace="spark-operator",
        application_file=spark_app_yaml_bh_ignite_ddb45dba2,
