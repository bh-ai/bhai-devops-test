...
common_task = CommonTask(dag_id='spark_engine_plain_vannila_543', dag_params={})
lineage_task = LineageTask(dag_id='spark_engine_plain_vannila_543', dag_params={})
...
with DAG(
    dag_id='spark_engine_plain_vannila_543',
    ...
    start_flow_task = PythonOperator(
        ...
        params = {
            'flow_id': 543,
            'flow_name': 'spark-engine-plain-vannila',
            'flow_key': 'spark_engine_plain_vannila',
            'bh_project_id': 299,
    ...
    pipeline_json_path = "/pipelines/bh_project_id=299/pipeline/pipeline_id=895/tpch_q3_shipping_priority_join_260529_2fca.json"
    ...
    spark_app_yaml_spark_engine_0b9437158 = f'''
    apiVersion: "sparkoperator.k8s.io/v1beta2"
    kind: SparkApplication
    metadata:
      name: "spark-app-spark-engine-0b9437158"
      namespace: "spark-operator"
    spec:
      type: Python
      pythonVersion: "3"
      mode: cluster
      image: "bhdwestus3acr01.azurecr.io/bh-transformation-utils/pyspark_slim:1.0.0-109-rc"
    ...
    spark_engine_0b9437158 = SparkKubernetesOperator(
        task_id='spark_engine_0b9437158',
        namespace="spark-operator",
        application_file=spark_app_yaml_spark_engine_0b9437158,
    ...
    start_flow_task >> spark_engine_0b9437158
    spark_engine_0b9437158 >> end_flow_task
