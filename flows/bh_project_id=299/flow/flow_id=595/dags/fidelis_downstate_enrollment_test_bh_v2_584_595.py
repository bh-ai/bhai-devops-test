...
common_task = CommonTask(dag_id='fidelis_downstate_enrollment_test_bh_v2_584_595', dag_params={})
lineage_task = LineageTask(dag_id='fidelis_downstate_enrollment_test_bh_v2_584_595', dag_params={})
...
with DAG(
    dag_id='fidelis_downstate_enrollment_test_bh_v2_584_595',
    ...
    start_flow_task = PythonOperator(
        ...
        params = {
            'flow_id': 595,
            'flow_name': 'Fidelis_downstate_enrollment_test_bh_v2_584',
            'flow_key': 'fidelis_downstate_enrollment_test_bh_v2_584',
            'bh_project_id': 299,
    ...
    _validate_params = {
        ...
        "sources": [
            {
                "source_name": "safeharbor_cinqdownstate_member_roster_04_02_2026",
                "prefix": "bhargs/1-Enrollment/1-Enrollment/Fedelis NY/Downstate/batch",
                "filename_regex": "safeharbor__CINQDOWNSTATE_Member_Roster_.*.csv",
    ...
    _submit_params = {
        ...
        "job_config": {
            ...
            "name": "{{ dag.dag_id }}_run_pipelines_fidelis_downstate_enrollment_test_bh_v2_{{ ts_nodash }}",
            "python_file": "/Workspace/Shared/dev-utils/pipelines/main.py",
            "parameters": [
                "/Workspace/Shared/codespace/test/pipelines/bh_project_id=299/pipeline/pipeline_id=1074/fidelis_downstate_enrollment_test_bh_v2.json",
                "databricks",
        ...
        "pipeline_name": "Fidelis_downstate_enrollment_test_bh_v2",
    ...
    run_pipelines_fidelis_downstate_enrollment_test_bh_v2 = PythonOperator(
        pre_execute=common_task.pre_execute_callback,
        task_id='run_pipelines_fidelis_downstate_enrollment_test_bh_v2',
    ...
    _submit_params = {
        ...
        "job_config": {
            "job_type": "spark_python",
            "name": "{{ dag.dag_id }}_run_pipelines_silver_raw_fidelis_ny_bh_to_members_dedupe_load_260617_4c89_{{ ts_nodash }}",
            "python_file": "/Workspace/Shared/dev-utils/pipelines/main.py",
            "parameters": [
                "/Workspace/Shared/codespace/test/pipelines/bh_project_id=299/pipeline/pipeline_id=1075/silver_raw_fidelis_ny_bh_to_members_dedupe_load_260617_4c89.json",
                "databricks",
                "/Workspace/Shared/dev-utils/schemas"
            ]
        },
    ...
    run_pipelines_silver_raw_fidelis_ny_bh_to_members_dedupe_load_260617_4c89 = PythonOperator(
        pre_execute=common_task.pre_execute_callback,
        task_id='run_pipelines_silver_raw_fidelis_ny_bh_to_members_dedupe_load_260617_4c89',
        python_callable=submit_job_to_cluster,
        params=_submit_params,
        on_success_callback=feed_control_callbacks.submit_job_success_callback,
        on_failure_callback=feed_control_callbacks.submit_job_failure_callback,
    ...
    create_compute >> run_pipelines_fidelis_downstate_enrollment_test_bh_v2
    run_pipelines_fidelis_downstate_enrollment_test_bh_v2 >> run_pipelines_silver_raw_fidelis_ny_bh_to_members_dedupe_load_260617_4c89
    create_compute >> run_pipelines_silver_raw_fidelis_ny_bh_to_members_dedupe_load_260617_4c89
    run_pipelines_silver_raw_fidelis_ny_bh_to_members_dedupe_load_260617_4c89 >> archive_processed_files
