...
common_task = CommonTask(dag_id='claims_fedeils_downstate_ip_2_377', dag_params={})
lineage_task = LineageTask(dag_id='claims_fedeils_downstate_ip_2_377', dag_params={})
...
with DAG(
    dag_id='claims_fedeils_downstate_ip_2_377',
    ...
    start_flow_task = PythonOperator(
        ...
        params = {
            'flow_id': 503,
            'flow_name': 'claims_fedeils_downstate_ip_2_377',
            'flow_key': 'claims_fedeils_downstate_ip_2_377',
            'bh_project_id': 299,
    ...
    _submit_params = {
        ...
        "job_config": {
            ...
            "name": "{{ dag.dag_id }}_run_pipelines_claims_fedeils_downstate_ip_2_{{ ts_nodash }}",
            "python_file": "/Workspace/Shared/dev-utils/pipelines/main.py",
            "parameters": [
                "/Workspace/Shared/codespace/test/pipelines/bh_project_id=299/pipeline/pipeline_id=777/claims_fedeils_downstate_ip_2.json",
                "databricks",
    ...
    run_pipelines_claims_fedeils_downstate_ip_2 = PythonOperator(
        pre_execute=common_task.pre_execute_callback,
        task_id='run_pipelines_claims_fedeils_downstate_ip_2',
    ...
    _submit_params = {
        ...
        "job_config": {
            "job_type": "spark_python",
            "name": "{{ dag.dag_id }}_run_pipelines_silver_raw_fidelis_ip_claims_to_cinqcare_silver_260520_3818_{{ ts_nodash }}",
            "python_file": "/Workspace/Shared/dev-utils/pipelines/main.py",
            "parameters": [
                "/Workspace/Shared/codespace/test/pipelines/bh_project_id=299/pipeline/pipeline_id=778/silver_raw_fidelis_ip_claims_to_cinqcare_silver_260520_3818.json",
                "databricks",
                "/Workspace/Shared/dev-utils/schemas"
            ]
        },
    ...
    run_pipelines_silver_raw_fidelis_ip_claims_to_cinqcare_silver_260520_3818 = PythonOperator(
        pre_execute=common_task.pre_execute_callback,
        task_id='run_pipelines_silver_raw_fidelis_ip_claims_to_cinqcare_silver_260520_3818',
        python_callable=submit_job_to_cluster,
        params=_submit_params,
        on_success_callback=common_task.success_callback,
        on_failure_callback=common_task.failure_callback,
    ...
    create_compute >> run_pipelines_claims_fedeils_downstate_ip_2
    run_pipelines_claims_fedeils_downstate_ip_2 >> run_pipelines_silver_raw_fidelis_ip_claims_to_cinqcare_silver_260520_3818
    create_compute >> run_pipelines_silver_raw_fidelis_ip_claims_to_cinqcare_silver_260520_3818
    run_pipelines_silver_raw_fidelis_ip_claims_to_cinqcare_silver_260520_3818 >> archive_processed_files
