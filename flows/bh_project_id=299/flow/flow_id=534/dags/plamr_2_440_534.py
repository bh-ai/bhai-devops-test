...
common_task = CommonTask(dag_id='plamr_2_440_534', dag_params={})
lineage_task = LineageTask(dag_id='plamr_2_440_534', dag_params={})
...
with DAG(
    ...
    start_flow_task = PythonOperator(
        ...
        params = {
            'flow_id': 534,
            'flow_name': 'plamr-2_440',
            'flow_key': 'plamr_2_440',
            'bh_project_id': 299,
    ...
    _submit_params = {
        ...
        "job_config": {
            ...
            "name": "{{ dag.dag_id }}_run_pipelines_plamr_2_{{ ts_nodash }}",
            "python_file": "/Workspace/Shared/dev-utils/pipelines/main.py",
            "parameters": [
                "/Workspace/Shared/codespace/test/pipelines/bh_project_id=299/pipeline/pipeline_id=874/plamr_2.json",
                "databricks",
    ...
    run_pipelines_plamr_2 = PythonOperator(
        pre_execute=common_task.pre_execute_callback,
        task_id='run_pipelines_plamr_2',
    ...
    create_compute >> run_pipelines_plamr_2
    run_pipelines_plamr_2 >> archive_processed_files
