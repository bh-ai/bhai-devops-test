...
common_task = CommonTask(dag_id='fedelis_may28_2_443_535', dag_params={})
lineage_task = LineageTask(dag_id='fedelis_may28_2_443_535', dag_params={})
...
with DAG(
    dag_id='fedelis_may28_2_443_535',
    ...
    start_flow_task = PythonOperator(
        ...
        params = {
            'flow_id': 535,
            'flow_name': 'fedelis-may28-2_443',
            'flow_key': 'fedelis_may28_2_443',
            'bh_project_id': 299,
    ...
    _submit_params = {
        ...
        "job_config": {
            ...
            "name": "{{ dag.dag_id }}_run_pipelines_fedelis_may28_2_{{ ts_nodash }}",
            "python_file": "/Workspace/Shared/dev-utils/pipelines/main.py",
            "parameters": [
                "/Workspace/Shared/codespace/test/pipelines/bh_project_id=299/pipeline/pipeline_id=875/fedelis_may28_2.json",
                "databricks",
    ...
    run_pipelines_fedelis_may28_2 = PythonOperator(
        pre_execute=common_task.pre_execute_callback,
        task_id='run_pipelines_fedelis_may28_2',
    ...
    _submit_params = {
        ...
        "job_config": {
            "job_type": "spark_python",
            "name": "{{ dag.dag_id }}_run_pipelines_silver_raw_fidelis_ny_member_enrollment_dedupe_load_260528_25a2_{{ ts_nodash }}",
            "python_file": "/Workspace/Shared/dev-utils/pipelines/main.py",
            "parameters": [
                "/Workspace/Shared/codespace/test/pipelines/bh_project_id=299/pipeline/pipeline_id=876/silver_raw_fidelis_ny_member_enrollment_dedupe_load_260528_25a2.json",
                "databricks",
                "/Workspace/Shared/dev-utils/schemas"
            ]
        },
    ...
    run_pipelines_silver_raw_fidelis_ny_member_enrollment_dedupe_load_260528_25a2 = PythonOperator(
        pre_execute=common_task.pre_execute_callback,
        task_id='run_pipelines_silver_raw_fidelis_ny_member_enrollment_dedupe_load_260528_25a2',
        python_callable=submit_job_to_cluster,
        params=_submit_params,
        on_success_callback=common_task.success_callback,
        on_failure_callback=common_task.failure_callback,
    ...
    create_compute >> run_pipelines_fedelis_may28_2
    run_pipelines_fedelis_may28_2 >> run_pipelines_silver_raw_fidelis_ny_member_enrollment_dedupe_load_260528_25a2
    create_compute >> run_pipelines_silver_raw_fidelis_ny_member_enrollment_dedupe_load_260528_25a2
    run_pipelines_silver_raw_fidelis_ny_member_enrollment_dedupe_load_260528_25a2 >> archive_processed_files
