...
common_task = CommonTask(dag_id='fidelis_upstate_enrollment_test_bh_688_637', dag_params={})
lineage_task = LineageTask(dag_id='fidelis_upstate_enrollment_test_bh_688_637', dag_params={})
...
with DAG(
    dag_id='fidelis_upstate_enrollment_test_bh_688_637',
    ...
    start_flow_task = PythonOperator(
        ...
        params = {
            'flow_id': 637,
            'flow_name': 'fidelis_upstate_enrollment_test_bh_688',
            'flow_key': 'fidelis_upstate_enrollment_test_bh_688',
            'bh_project_id': 299,
    ...
    _validate_params = {
        ...
        "source_prefix": "bhargs/1-Enrollment/1-Enrollment/Fedelis NY/Downstate/Batch",
        ...
        "control_schema": None,
        "feed_name": "fidelis_upstate_enrollment_test_bh"
    }
    ...
    def create_databricks_cluster_create_compute(**context):
        ...
        payload = (
            {
                "cluster_name": "databricks_spark_cluster",
                ...
                "spark_conf": {
                    ...
                    "spark.costanalyzer.outputDir": "abfss://my-test-bucket@bhnprddwestus3rgbd5e.dfs.core.windows.net/spark-metrics/637/fidelis_upstate_enrollment_test_bh_688/",
                    "spark.flow.id": "637",
                ...
                "spark_custom_listener": {
                    ...
                    "blob_secrets_scope": "bh_secret_scope_verato"
                }
            }
        )

        _blob_secrets_scope = "bh_secret_scope_verato"
    ...
    _submit_params = {
        ...
        "job_config": {
            ...
            "spark_conf": {
                "spark.pipeline.id": "1186",
                "spark.pipeline.name": "fidelis_upstate_enrollment_test_bh"
            }
        },
        "ingestion_group_id": 688,
        "flow_id": 637,
        ...
        "pipeline_name": "fidelis_upstate_enrollment_test_bh",
        "metrics_output_dir": "abfss://my-test-bucket@bhnprddwestus3rgbd5e.dfs.core.windows.net/spark-metrics/637/fidelis_upstate_enrollment_test_bh_688/",
        "blob_secrets_scope": "bh_secret_scope_verato",
    ...
    run_pipelines_fidelis_upstate_enrollment_test_bh = PythonOperator(
        pre_execute=common_task.pre_execute_callback,
        task_id='run_pipelines_fidelis_upstate_enrollment_test_bh',
    ...
    _submit_params = {
        ...
        "job_config": {
            ...
            "spark_conf": {
                "spark.pipeline.id": "1187",
                "spark.pipeline.name": "silver_raw_fidelis_ny_dedupe_to_members_load_260709_2330"
            }
        },
        "ingestion_group_id": 688,
        "flow_id": 637,
        ...
        "validate_inbound_task_id": "validate_inbound_files",
        "facts_source": "databricks",
        "pipeline_name": "silver_raw_fidelis_ny_dedupe_to_members_load_260709_2330",
        "metrics_output_dir": "abfss://my-test-bucket@bhnprddwestus3rgbd5e.dfs.core.windows.net/spark-metrics/637/fidelis_upstate_enrollment_test_bh_688/",
        "blob_secrets_scope": "bh_secret_scope_verato",
        "metrics_storage_secret_name": "bh-dev-westus3-kv-key-scope/bh-azureblob-azureblob",
        "compute_xcom_key": "return_value",
    ...
    run_pipelines_silver_raw_fidelis_ny_dedupe_to_members_load_260709_2330 = PythonOperator(
        pre_execute=common_task.pre_execute_callback,
        task_id='run_pipelines_silver_raw_fidelis_ny_dedupe_to_members_load_260709_2330',
        python_callable=submit_job_to_cluster,
        params=_submit_params,
        on_success_callback=feed_control_callbacks.submit_job_success_callback,
        on_failure_callback=feed_control_callbacks.submit_job_failure_callback,
    ...
    _archive_params = {
        "bucket_name": "my-test-bucket",
        "source_prefix": "",
        "archive_prefix": "Archive/bhargs/1-Enrollment/1-Enrollment/Fedelis NY/Downstate/Batch",
        "cloud_type": "databricks",
        "airflow_connection_id": "databricks_default",
        "secret_name": "bh-dev-westus3-kv-key-scope/bh-azureblob-azureblob",
        "delete_source": True,
    ...
    from airflow_plugins.tools.bh_tools.spark_metrics_analyze import (
        analyze_and_publish_performance_insights,
    )

    def _analyze_spark_metrics(**context):
        params = context.get("params") or {}
        if not str(params.get("metrics_output_dir") or "").strip():
            from airflow.exceptions import AirflowSkipException
            raise AirflowSkipException(
                "Skipping AnalyzeSparkMetrics: metrics_output_dir is not configured "
                "(listener not enabled on upstream SubmitJob)"
            )
        analyze_and_publish_performance_insights(context)
    ...
    _analyze_params = {
        ...
        "airflow_connection_id": "databricks_default",
        "submit_task_id": "run_pipelines_fidelis_upstate_enrollment_test_bh",
        "pipeline_id": 1186,
        "pipeline_name": "fidelis_upstate_enrollment_test_bh",
        "project_id": 299,
        "bh_project_id": 299,
    ...
    analyze_spark_metrics = PythonOperator(
        pre_execute=common_task.pre_execute_callback,
        task_id='analyze_spark_metrics',
        python_callable=_analyze_spark_metrics,
    ...
    create_compute >> run_pipelines_fidelis_upstate_enrollment_test_bh
    run_pipelines_fidelis_upstate_enrollment_test_bh >> run_pipelines_silver_raw_fidelis_ny_dedupe_to_members_load_260709_2330
    create_compute >> run_pipelines_silver_raw_fidelis_ny_dedupe_to_members_load_260709_2330
    run_pipelines_silver_raw_fidelis_ny_dedupe_to_members_load_260709_2330 >> archive_processed_files
    archive_processed_files >> delete_compute
    analyze_spark_metrics >> delete_compute
    create_compute >> delete_compute
    run_pipelines_fidelis_upstate_enrollment_test_bh >> analyze_spark_metrics
    run_pipelines_silver_raw_fidelis_ny_dedupe_to_members_load_260709_2330 >> analyze_spark_metrics
