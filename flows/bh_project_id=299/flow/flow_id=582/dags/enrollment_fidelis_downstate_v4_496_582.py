...
common_task = CommonTask(dag_id='enrollment_fidelis_downstate_v4_496_582', dag_params={})
lineage_task = LineageTask(dag_id='enrollment_fidelis_downstate_v4_496_582', dag_params={})
...
with DAG(
    dag_id='enrollment_fidelis_downstate_v4_496_582',
    ...
    start_flow_task = PythonOperator(
        ...
        params = {
            'flow_id': 582,
            'flow_name': 'Enrollment_fidelis_downstate_v4_496',
            'flow_key': 'enrollment_fidelis_downstate_v4_496',
            'bh_project_id': 299,
    ...
    _validate_params = {
        ...
        "sources": [
            {
                ...
                "filename_regex": "^safeharbor__CINQDOWNSTATE_Member_Roster_[0-9]{2}_[0-9]{2}_[0-9]{4}[.]csv$",
        ...
        "feed_name": "Enrollment_fidelis_downstate_v4"
    }
    ...
    _submit_params = {
        ...
        "pipeline_name": "Enrollment_fidelis_downstate_v4",
    ...
    run_pipelines_enrollment_fidelis_downstate_v4 = PythonOperator(
        pre_execute=common_task.pre_execute_callback,
        task_id='run_pipelines_enrollment_fidelis_downstate_v4',
    ...
    _submit_params = {
        ...
        "job_config": {
            "job_type": "spark_python",
            "name": "{{ dag.dag_id }}_run_pipelines_silver_raw_fidelis_roster_dedupe_to_member_load_260603_cb89_{{ ts_nodash }}",
            "python_file": "/Workspace/Shared/dev-utils/pipelines/main.py",
            "parameters": [
                "/Workspace/Shared/codespace/test/pipelines/bh_project_id=299/pipeline/pipeline_id=976/silver_raw_fidelis_roster_dedupe_to_member_load_260603_cb89.json",
                "databricks",
                "/Workspace/Shared/dev-utils/schemas"
            ]
        },
        ...
        "validate_inbound_task_id": "validate_inbound_files",
        "facts_source": "databricks",
        "pipeline_name": "silver_raw_fidelis_roster_dedupe_to_member_load_260603_cb89",
        "compute_xcom_key": "return_value",
        "valid_files": "{{ task_instance.xcom_pull(task_ids='validate_inbound_files', key='valid_files') }}",
        "batch_id": "{{ task_instance.xcom_pull(task_ids='validate_inbound_files', key='batch_id') }}"
    }
    run_pipelines_silver_raw_fidelis_roster_dedupe_to_member_load_260603_cb89 = PythonOperator(
        pre_execute=common_task.pre_execute_callback,
        task_id='run_pipelines_silver_raw_fidelis_roster_dedupe_to_member_load_260603_cb89',
        python_callable=submit_job_to_cluster,
        params=_submit_params,
        on_success_callback=feed_control_callbacks.submit_job_success_callback,
        on_failure_callback=feed_control_callbacks.submit_job_failure_callback,
    ...
    create_compute >> run_pipelines_enrollment_fidelis_downstate_v4
    run_pipelines_enrollment_fidelis_downstate_v4 >> run_pipelines_silver_raw_fidelis_roster_dedupe_to_member_load_260603_cb89
    create_compute >> run_pipelines_silver_raw_fidelis_roster_dedupe_to_member_load_260603_cb89
    run_pipelines_silver_raw_fidelis_roster_dedupe_to_member_load_260603_cb89 >> archive_processed_files
