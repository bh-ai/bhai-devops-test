...
common_task = CommonTask(dag_id='fidelis_upstate_enrollment_test_bh_v2_589_598', dag_params={})
lineage_task = LineageTask(dag_id='fidelis_upstate_enrollment_test_bh_v2_589_598', dag_params={})
...
with DAG(
    dag_id='fidelis_upstate_enrollment_test_bh_v2_589_598',
    ...
    start_flow_task = PythonOperator(
        ...
        params = {
            'flow_id': 598,
            'flow_name': 'fidelis_upstate_enrollment_test_bh_v2_589',
            'flow_key': 'fidelis_upstate_enrollment_test_bh_v2_589',
            'bh_project_id': 299,
    ...
    def validate_inbound_files(**context):
        ...
        warehouse_id = Variable.get("default_databricks_warehouse_id", default_var=None)
        control_catalog = (
            params.get("control_catalog")
            or Variable.get("default_control_catalog", default_var="cinqdev")
        )
        control_schema = (
            params.get("control_schema")
            or Variable.get("default_control_schema", default_var="control")
        )
        ...
        if warehouse_id and cloud_type == "databricks":
            try:
                ...
                dbr_conn = BaseHook.get_connection(airflow_connection_id)
                dbr_host = dbr_conn.host.rstrip("/")
                dbr_token = dbr_conn.password
    ...
    _validate_params = {
        ...
        "source_prefix": "bhargs/1-Enrollment/1-Enrollment/Fedelis NY/Upstate",
        ...
        "sources": [
            {
                "source_name": "safeharbor_cinqupstate_member_roster_03_05_2026",
                "prefix": "bhargs/1-Enrollment/1-Enrollment/Fedelis NY/Upstate",
                "filename_regex": "safeharbor_CINQUPSTATE_Member_Roster_0.*.csv",
        ...
        "feed_name": "fidelis_upstate_enrollment_test_bh_v2"
    }
    ...
    _submit_params = {
        ...
        "job_config": {
            ...
            "name": "{{ dag.dag_id }}_run_pipelines_fidelis_upstate_enrollment_test_bh_v2_{{ ts_nodash }}",
            "python_file": "/Workspace/Shared/dev-utils/pipelines/main.py",
            "parameters": [
                "/Workspace/Shared/codespace/test/pipelines/bh_project_id=299/pipeline/pipeline_id=1082/fidelis_upstate_enrollment_test_bh_v2.json",
                "databricks",
        ...
        "pipeline_name": "fidelis_upstate_enrollment_test_bh_v2",
    ...
    run_pipelines_fidelis_upstate_enrollment_test_bh_v2 = PythonOperator(
        pre_execute=common_task.pre_execute_callback,
        task_id='run_pipelines_fidelis_upstate_enrollment_test_bh_v2',
    ...
    _submit_params = {
        ...
        "job_config": {
            "job_type": "spark_python",
            "name": "{{ dag.dag_id }}_run_pipelines_silver_raw_fidelis_upstate_ny_enrollment_to_members_dedupe_load_260617_51a7_{{ ts_nodash }}",
            "python_file": "/Workspace/Shared/dev-utils/pipelines/main.py",
            "parameters": [
                "/Workspace/Shared/codespace/test/pipelines/bh_project_id=299/pipeline/pipeline_id=1083/silver_raw_fidelis_upstate_ny_enrollment_to_members_dedupe_load_260617_51a7.json",
                "databricks",
                "/Workspace/Shared/dev-utils/schemas"
            ]
        },
        ...
        "validate_inbound_task_id": "validate_inbound_files",
        "facts_source": "databricks",
        "pipeline_name": "silver_raw_fidelis_upstate_ny_enrollment_to_members_dedupe_load_260617_51a7",
        "compute_xcom_key": "return_value",
        "valid_files": "{{ task_instance.xcom_pull(task_ids='validate_inbound_files', key='valid_files') }}",
        "batch_id": "{{ task_instance.xcom_pull(task_ids='validate_inbound_files', key='batch_id') }}"
    }
    run_pipelines_silver_raw_fidelis_upstate_ny_enrollment_to_members_dedupe_load_260617_51a7 = PythonOperator(
        pre_execute=common_task.pre_execute_callback,
        task_id='run_pipelines_silver_raw_fidelis_upstate_ny_enrollment_to_members_dedupe_load_260617_51a7',
        python_callable=submit_job_to_cluster,
        params=_submit_params,
        on_success_callback=feed_control_callbacks.submit_job_success_callback,
        on_failure_callback=feed_control_callbacks.submit_job_failure_callback,
    ...
    _archive_params = {
        "bucket_name": "my-test-bucket",
        "source_prefix": "",
        "archive_prefix": "Archive/bhargs/1-Enrollment/1-Enrollment/Fedelis NY/Upstate",
        "cloud_type": "databricks",
        "airflow_connection_id": "databricks_default",
        "secret_name": "bh-dev-westus3-kv-key-scope/bh-azureblob-azureblob",
        "delete_source": True,
    ...
    create_compute >> run_pipelines_fidelis_upstate_enrollment_test_bh_v2
    run_pipelines_fidelis_upstate_enrollment_test_bh_v2 >> run_pipelines_silver_raw_fidelis_upstate_ny_enrollment_to_members_dedupe_load_260617_51a7
    create_compute >> run_pipelines_silver_raw_fidelis_upstate_ny_enrollment_to_members_dedupe_load_260617_51a7
    run_pipelines_silver_raw_fidelis_upstate_ny_enrollment_to_members_dedupe_load_260617_51a7 >> archive_processed_files
