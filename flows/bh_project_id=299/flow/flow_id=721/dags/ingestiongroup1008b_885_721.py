...
common_task = CommonTask(dag_id='ingestiongroup1008b_885_721', dag_params={})
lineage_task = LineageTask(dag_id='ingestiongroup1008b_885_721', dag_params={})
...
with DAG(
    ...
    start_flow_task = PythonOperator(
        ...
        params = {
            'flow_id': 721,
            'flow_name': 'ingestiongroup1008b_885',
            'flow_key': 'ingestiongroup1008b_885',
            'bh_project_id': 299,
    ...
    run_pipelines_ingestiongroup1008b = PythonOperator(
        pre_execute=common_task.pre_execute_callback,
        task_id='run_pipelines_ingestiongroup1008b',
