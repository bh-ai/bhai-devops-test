...
common_task = CommonTask(dag_id='sv_local_4_619_616', dag_params={})
lineage_task = LineageTask(dag_id='sv_local_4_619_616', dag_params={})
...
with DAG(
    ...
    start_flow_task = PythonOperator(
        ...
        params = {
            'flow_id': 616,
            'flow_name': 'sv_local_4_619',
            'flow_key': 'sv_local_4_619',
            'bh_project_id': 299,
    ...
    _submit_params = {
        ...
        "job_config": {
            ...
            "name": "{{ dag.dag_id }}_run_pipelines_sv_local_4_{{ ts_nodash }}",
            "python_file": "/Workspace/Shared/dev-utils/pipelines/main.py",
            "parameters": [
                "/Workspace/Shared/codespace/test/pipelines/bh_project_id=299/pipeline/pipeline_id=1114/sv_local_4.json",
                "databricks",
    ...
    run_pipelines_sv_local_4 = PythonOperator(
        pre_execute=common_task.pre_execute_callback,
        task_id='run_pipelines_sv_local_4',
    ...
    create_compute >> run_pipelines_sv_local_4
    run_pipelines_sv_local_4 >> run_pipelines_enrollment_fidelis_downstate_v4
    create_compute >> run_pipelines_enrollment_fidelis_downstate_v4
    run_pipelines_enrollment_fidelis_downstate_v4 >> archive_processed_files
