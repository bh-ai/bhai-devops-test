...
common_task = CommonTask(dag_id='ingestiongroup217a_776_682', dag_params={})
lineage_task = LineageTask(dag_id='ingestiongroup217a_776_682', dag_params={})
...
with DAG(
    dag_id='ingestiongroup217a_776_682',
    ...
    start_flow_task = PythonOperator(
        ...
        params = {
            'flow_id': 682,
            'flow_name': 'ingestiongroup217a_776',
            'flow_key': 'ingestiongroup217a_776',
            'bh_project_id': 299,
    ...
    _submit_params = {
        ...
        "job_config": {
            ...
            "name": "{{ dag.dag_id }}_run_pipelines_ingestiongroup217a_{{ ts_nodash }}",
            "python_file": "/Workspace/Shared/dev-utils/pipelines/main.py",
            "parameters": [
                "/Workspace/Shared/codespace/test/pipelines/bh_project_id=299/pipeline/pipeline_id=1322/ingestiongroup217a.json",
                "databricks",
    ...
    run_pipelines_ingestiongroup217a = PythonOperator(
        pre_execute=common_task.pre_execute_callback,
        task_id='run_pipelines_ingestiongroup217a',
    ...
    _submit_params = {
        ...
        "job_config": {
            "job_type": "spark_python",
            "name": "{{ dag.dag_id }}_run_pipelines_silver_raw_safeharbor_to_members_dedupe_load_260721_c73d_{{ ts_nodash }}",
            "python_file": "/Workspace/Shared/dev-utils/pipelines/main.py",
            "parameters": [
                "/Workspace/Shared/codespace/test/pipelines/bh_project_id=299/pipeline/pipeline_id=1323/silver_raw_safeharbor_to_members_dedupe_load_260721_c73d.json",
                "databricks",
                "/Workspace/Shared/dev-utils/schemas"
            ]
        },
    ...
    run_pipelines_silver_raw_safeharbor_to_members_dedupe_load_260721_c73d = PythonOperator(
        pre_execute=common_task.pre_execute_callback,
        task_id='run_pipelines_silver_raw_safeharbor_to_members_dedupe_load_260721_c73d',
        python_callable=submit_job_to_cluster,
        params=_submit_params,
        on_success_callback=feed_control_callbacks.submit_job_success_callback,
        on_failure_callback=feed_control_callbacks.submit_job_failure_callback,
    ...
    create_compute >> run_pipelines_ingestiongroup217a
    run_pipelines_ingestiongroup217a >> run_pipelines_silver_raw_safeharbor_to_members_dedupe_load_260721_c73d
    create_compute >> run_pipelines_silver_raw_safeharbor_to_members_dedupe_load_260721_c73d
    run_pipelines_silver_raw_safeharbor_to_members_dedupe_load_260721_c73d >> archive_processed_files
