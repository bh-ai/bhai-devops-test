...
common_task = CommonTask(dag_id='sv_local_5_620_617', dag_params={})
lineage_task = LineageTask(dag_id='sv_local_5_620_617', dag_params={})
...
with DAG(
    ...
    start_flow_task = PythonOperator(
        ...
        params = {
            'flow_id': 617,
            'flow_name': 'sv_local_5_620',
            'flow_key': 'sv_local_5_620',
            'bh_project_id': 299,
    ...
    _validate_params = {
        ...
        "min_files": 1,
        "max_files": None,
        "quarantine_prefix": "bhargs/1-Enrollment/1-Enrollment/Centene GA Risk/rejected",
    ...
    _submit_params = {
        ...
        "job_config": {
            ...
            "name": "{{ dag.dag_id }}_run_pipelines_sv_local_5_{{ ts_nodash }}",
            "python_file": "/Workspace/Shared/dev-utils/pipelines/main.py",
            "parameters": [
                "/Workspace/Shared/codespace/test/pipelines/bh_project_id=299/pipeline/pipeline_id=1115/sv_local_5.json",
                "databricks",
    ...
    run_pipelines_sv_local_5 = PythonOperator(
        pre_execute=common_task.pre_execute_callback,
        task_id='run_pipelines_sv_local_5',
    ...
    _submit_params = {
        ...
        "job_config": {
            "job_type": "spark_python",
            "name": "{{ dag.dag_id }}_run_pipelines_silver_raw_sv_local_5_member_enrollment_load_260626_7bc6_{{ ts_nodash }}",
            "python_file": "/Workspace/Shared/dev-utils/pipelines/main.py",
            "parameters": [
                "/Workspace/Shared/codespace/test/pipelines/bh_project_id=299/pipeline/pipeline_id=1116/silver_raw_sv_local_5_member_enrollment_load_260626_7bc6.json",
                "databricks",
                "/Workspace/Shared/dev-utils/schemas"
            ]
        },
        ...
        "validate_inbound_task_id": "validate_inbound_files",
        "facts_source": "databricks",
        "pipeline_name": "silver_raw_sv_local_5_member_enrollment_load_260626_7bc6",
        "compute_xcom_key": "return_value",
        "valid_files": "{{ task_instance.xcom_pull(task_ids='validate_inbound_files', key='valid_files') }}",
        "batch_id": "{{ task_instance.xcom_pull(task_ids='validate_inbound_files', key='batch_id') }}"
    }
    run_pipelines_silver_raw_sv_local_5_member_enrollment_load_260626_7bc6 = PythonOperator(
        pre_execute=common_task.pre_execute_callback,
        task_id='run_pipelines_silver_raw_sv_local_5_member_enrollment_load_260626_7bc6',
        python_callable=submit_job_to_cluster,
        params=_submit_params,
        on_success_callback=feed_control_callbacks.submit_job_success_callback,
        on_failure_callback=feed_control_callbacks.submit_job_failure_callback,
    ...
    create_compute >> run_pipelines_sv_local_5
    run_pipelines_sv_local_5 >> run_pipelines_silver_raw_sv_local_5_member_enrollment_load_260626_7bc6
    create_compute >> run_pipelines_silver_raw_sv_local_5_member_enrollment_load_260626_7bc6
    run_pipelines_silver_raw_sv_local_5_member_enrollment_load_260626_7bc6 >> archive_processed_files
