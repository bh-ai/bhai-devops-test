...
common_task = CommonTask(dag_id='ingestiongroup1607c_760_669', dag_params={})
lineage_task = LineageTask(dag_id='ingestiongroup1607c_760_669', dag_params={})
...
with DAG(
    dag_id='ingestiongroup1607c_760_669',
    ...
    start_flow_task = PythonOperator(
        ...
        params = {
            'flow_id': 669,
            'flow_name': 'ingestiongroup1607c_760',
            'flow_key': 'ingestiongroup1607c_760',
            'bh_project_id': 299,
        ...
        payload = (
            {
                ...
                "spark_conf": {
                    ...
                    "spark.costanalyzer.outputDir": "abfss://my-test-bucket@bhnprddwestus3rgbd5e.dfs.core.windows.net/spark-metrics/669/ingestiongroup1607c_760/",
                    "spark.flow.id": "669",
    ...
    _submit_params = {
        ...
        "job_config": {
            ...
            "spark_conf": {
                "spark.pipeline.id": "1286",
                "spark.pipeline.name": "ingestiongroup1607c"
            }
        },
        "ingestion_group_id": 760,
        "flow_id": 669,
        ...
        "metrics_output_dir": "abfss://my-test-bucket@bhnprddwestus3rgbd5e.dfs.core.windows.net/spark-metrics/669/ingestiongroup1607c_760/",
        "blob_secrets_scope": "bh-dev-test-key-scope",
        ...
        "airflow_connection_id": "databricks_default",
        "pipeline_key": "ingestiongroup1607c",
    ...
    run_pipelines_ingestiongroup1607c = PythonOperator(
        pre_execute=common_task.pre_execute_callback,
        task_id='run_pipelines_ingestiongroup1607c',
    ...
    _submit_params = {
        ...
        "job_config": {
            ...
            "spark_conf": {
                "spark.pipeline.id": "1288",
                "spark.pipeline.name": "silver_raw_safeharbor_to_members_dedupe_load_260716_3dcf"
            }
        },
        "ingestion_group_id": 760,
        "flow_id": 669,
        ...
        "cloud_provider": "databricks",
        "airflow_connection_id": "databricks_default",
        "pipeline_key": "silver_raw_safeharbor_to_members_dedupe_load_260716_3dcf",
        "compute_xcom_key": "return_value",
        "valid_files": "{{ task_instance.xcom_pull(task_ids='validate_inbound_files', key='valid_files') }}",
        "batch_id": "{{ task_instance.xcom_pull(task_ids='validate_inbound_files', key='batch_id') }}"
    }
    run_pipelines_silver_raw_safeharbor_to_members_dedupe_load_260716_3dcf = PythonOperator(
        pre_execute=common_task.pre_execute_callback,
        task_id='run_pipelines_silver_raw_safeharbor_to_members_dedupe_load_260716_3dcf',
        python_callable=submit_job_to_cluster,
        params=_submit_params,
        on_success_callback=feed_control_callbacks.submit_job_success_callback,
        on_failure_callback=feed_control_callbacks.submit_job_failure_callback,
    ...
    create_compute >> run_pipelines_ingestiongroup1607c
    run_pipelines_ingestiongroup1607c >> run_pipelines_silver_raw_safeharbor_to_members_dedupe_load_260716_3dcf
    create_compute >> run_pipelines_silver_raw_safeharbor_to_members_dedupe_load_260716_3dcf
    run_pipelines_silver_raw_safeharbor_to_members_dedupe_load_260716_3dcf >> archive_processed_files
