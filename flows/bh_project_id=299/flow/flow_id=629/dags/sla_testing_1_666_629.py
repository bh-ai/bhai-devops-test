...
common_task = CommonTask(dag_id='sla_testing_1_666_629', dag_params={})
lineage_task = LineageTask(dag_id='sla_testing_1_666_629', dag_params={})
...
with DAG(
    ...
    start_flow_task = PythonOperator(
        ...
        params = {
            'flow_id': 629,
            'flow_name': 'sla_testing_1_666',
            'flow_key': 'sla_testing_1_666',
            'bh_project_id': 299,
    ...
    run_jobs_sla_testing_1 = PythonOperator(
        pre_execute=common_task.pre_execute_callback,
        task_id='run_jobs_sla_testing_1',
    ...
    run_jobs_silver_raw_cinqcare_elig_to_members_load_260703_2795 = PythonOperator(
        pre_execute=common_task.pre_execute_callback,
        task_id='run_jobs_silver_raw_cinqcare_elig_to_members_load_260703_2795',
        python_callable=submit_job_to_cluster,
        params=_submit_params,
        on_success_callback=feed_control_callbacks.submit_job_success_callback,
        on_failure_callback=feed_control_callbacks.submit_job_failure_callback,
    ...
    create_compute >> run_jobs_sla_testing_1
    run_jobs_sla_testing_1 >> run_jobs_silver_raw_cinqcare_elig_to_members_load_260703_2795
    create_compute >> run_jobs_silver_raw_cinqcare_elig_to_members_load_260703_2795
    run_jobs_silver_raw_cinqcare_elig_to_members_load_260703_2795 >> delete_compute
