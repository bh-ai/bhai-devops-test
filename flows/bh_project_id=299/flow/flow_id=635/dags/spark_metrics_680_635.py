...
common_task = CommonTask(dag_id='spark_metrics_680_635', dag_params={})
lineage_task = LineageTask(dag_id='spark_metrics_680_635', dag_params={})
...
with DAG(
    ...
    start_flow_task = PythonOperator(
        ...
        params = {
            'flow_id': 635,
            'flow_name': 'spark metrics_680',
            'flow_key': 'spark_metrics_680',
            'bh_project_id': 299,
        ...
        "sources": [
            {
                ...
                "prefix": "local",
                "filename_regex": "employees_1_v31.csv",
        ...
        payload = (
            {
                ...
                "spark_conf": {
                    ...
                    "spark.costanalyzer.outputDir": "abfss://my-test-bucket@bhnprddwestus3rgbd5e.dfs.core.windows.net/spark-metrics/635/spark_metrics_680/",
                    "spark.flow.id": "635",
    ...
    _submit_params = {
        ...
        "job_config": {
            ...
            "spark_conf": {
                "spark.pipeline.id": "1174",
                "spark.pipeline.name": "employees_1_v31_680"
            }
        },
        "ingestion_group_id": 680,
        "flow_id": 635,
        ...
        "pipeline_name": "employees_1_v31_680",
        "metrics_output_dir": "abfss://my-test-bucket@bhnprddwestus3rgbd5e.dfs.core.windows.net/spark-metrics/635/spark_metrics_680/",
        "blob_secrets_scope": "bh_secret_scope_verato",
    ...
    run_pipelines_employees_1_v31_680 = PythonOperator(
        pre_execute=common_task.pre_execute_callback,
        task_id='run_pipelines_employees_1_v31_680',
    ...
    _analyze_params = {
        ...
        "airflow_connection_id": "databricks_default",
        "submit_task_id": "run_pipelines_employees_1_v31_680",
        "pipeline_id": 1174,
        "pipeline_name": "employees_1_v31_680",
        "project_id": 299,
        "bh_project_id": 299,
    ...
    create_compute >> run_pipelines_employees_1_v31_680
    run_pipelines_employees_1_v31_680 >> archive_processed_files
    archive_processed_files >> delete_compute
    analyze_spark_metrics >> delete_compute
    create_compute >> delete_compute
    run_pipelines_employees_1_v31_680 >> analyze_spark_metrics
