...
common_task = CommonTask(dag_id='ingestiongroup107107107_726_642', dag_params={})
lineage_task = LineageTask(dag_id='ingestiongroup107107107_726_642', dag_params={})
...
with DAG(
    dag_id='ingestiongroup107107107_726_642',
    ...
    start_flow_task = PythonOperator(
        ...
        params = {
            'flow_id': 642,
            'flow_name': 'ingestiongroup107107107_726',
            'flow_key': 'ingestiongroup107107107_726',
            'bh_project_id': 299,
    ...
    _validate_params = {
        ...
        "sources": [
            {
                "source_name": "safeharbor_cinqdownstate_member_roster_06_05_2026",
                "prefix": "bhargs/1-Enrollment/1-Enrollment/fedelisny/Batch",
                "filename_regex": "safeharbor_CINQDOWNSTATE_Member_Roster_06_05_2026.xlsx",
        ...
        "control_schema": None,
        "feed_name": "ingestiongroup107107107",
        "feed_id": "ingestiongroup107107107"
    }
    ...
    _submit_params = {
        ...
        "job_config": {
            ...
            "name": "{{ dag.dag_id }}_run_pipelines_ingestiongroup107107107_{{ ts_nodash }}",
            "python_file": "/Workspace/Shared/dev-utils/pipelines/main.py",
            "parameters": [
                "/Workspace/Shared/codespace/test/pipelines/bh_project_id=299/pipeline/pipeline_id=1209/ingestiongroup107107107.json",
                "databricks",
        ...
        "pipeline_name": "ingestiongroup107107107",
    ...
    run_pipelines_ingestiongroup107107107 = PythonOperator(
        pre_execute=common_task.pre_execute_callback,
        task_id='run_pipelines_ingestiongroup107107107',
    ...
    _submit_params = {
        ...
        "job_config": {
            "job_type": "spark_python",
            "name": "{{ dag.dag_id }}_run_pipelines_silver_raw_safeharbor_to_members_dedupe_load_260710_20af_{{ ts_nodash }}",
            "python_file": "/Workspace/Shared/dev-utils/pipelines/main.py",
            "parameters": [
                "/Workspace/Shared/codespace/test/pipelines/bh_project_id=299/pipeline/pipeline_id=1210/silver_raw_safeharbor_to_members_dedupe_load_260710_20af.json",
                "databricks",
                "/Workspace/Shared/dev-utils/schemas"
            ]
        },
        ...
        "validate_inbound_task_id": "validate_inbound_files",
        "facts_source": "databricks",
        "pipeline_name": "silver_raw_safeharbor_to_members_dedupe_load_260710_20af",
        "compute_xcom_key": "return_value",
        "valid_files": "{{ task_instance.xcom_pull(task_ids='validate_inbound_files', key='valid_files') }}",
        "batch_id": "{{ task_instance.xcom_pull(task_ids='validate_inbound_files', key='batch_id') }}"
    }
    run_pipelines_silver_raw_safeharbor_to_members_dedupe_load_260710_20af = PythonOperator(
        pre_execute=common_task.pre_execute_callback,
        task_id='run_pipelines_silver_raw_safeharbor_to_members_dedupe_load_260710_20af',
        python_callable=submit_job_to_cluster,
        params=_submit_params,
        on_success_callback=feed_control_callbacks.submit_job_success_callback,
        on_failure_callback=feed_control_callbacks.submit_job_failure_callback,
    ...
    create_compute >> run_pipelines_ingestiongroup107107107
    run_pipelines_ingestiongroup107107107 >> run_pipelines_silver_raw_safeharbor_to_members_dedupe_load_260710_20af
    create_compute >> run_pipelines_silver_raw_safeharbor_to_members_dedupe_load_260710_20af
    run_pipelines_silver_raw_safeharbor_to_members_dedupe_load_260710_20af >> archive_processed_files
