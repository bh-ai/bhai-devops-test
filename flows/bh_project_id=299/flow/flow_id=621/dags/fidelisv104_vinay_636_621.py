...
common_task = CommonTask(dag_id='fidelisv104_vinay_636_621', dag_params={})
lineage_task = LineageTask(dag_id='fidelisv104_vinay_636_621', dag_params={})
...
with DAG(
    dag_id='fidelisv104_vinay_636_621',
    ...
    start_flow_task = PythonOperator(
        ...
        params = {
            'flow_id': 621,
            'flow_name': 'fidelisv104_vinay_636',
            'flow_key': 'fidelisv104_vinay_636',
            'bh_project_id': 299,
    ...
    _submit_params = {
        ...
        "pipeline_name": "fidelis104_ny_636",
    ...
    run_pipelines_fidelis104_ny_636 = PythonOperator(
        pre_execute=common_task.pre_execute_callback,
        task_id='run_pipelines_fidelis104_ny_636',
    ...
    _submit_params = {
        ...
        "validate_inbound_task_id": "validate_inbound_files",
        "facts_source": "databricks",
        "pipeline_name": "silver_raw_fidelis_ny_dedupe_to_members_load_260629_fc1c",
        "compute_xcom_key": "return_value",
        "valid_files": "{{ task_instance.xcom_pull(task_ids='validate_inbound_files', key='valid_files') }}",
        "batch_id": "{{ task_instance.xcom_pull(task_ids='validate_inbound_files', key='batch_id') }}"
    }
    run_pipelines_silver_raw_fidelis_ny_dedupe_to_members_load_260629_fc1c = PythonOperator(
        pre_execute=common_task.pre_execute_callback,
        task_id='run_pipelines_silver_raw_fidelis_ny_dedupe_to_members_load_260629_fc1c',
        python_callable=submit_job_to_cluster,
        params=_submit_params,
        on_success_callback=feed_control_callbacks.submit_job_success_callback,
        on_failure_callback=feed_control_callbacks.submit_job_failure_callback,
    ...
    create_compute >> run_pipelines_fidelis104_ny_636
    run_pipelines_fidelis104_ny_636 >> run_pipelines_silver_raw_fidelis_ny_dedupe_to_members_load_260629_fc1c
    create_compute >> run_pipelines_silver_raw_fidelis_ny_dedupe_to_members_load_260629_fc1c
    run_pipelines_silver_raw_fidelis_ny_dedupe_to_members_load_260629_fc1c >> archive_processed_files
