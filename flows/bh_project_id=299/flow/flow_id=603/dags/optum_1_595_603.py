...
common_task = CommonTask(dag_id='optum_1_595_603', dag_params={})
lineage_task = LineageTask(dag_id='optum_1_595_603', dag_params={})
...
with DAG(
    ...
    start_flow_task = PythonOperator(
        ...
        params = {
            'flow_id': 603,
            'flow_name': 'optum_1_595',
            'flow_key': 'optum_1_595',
            'bh_project_id': 299,
    ...
    _validate_params = {
        ...
        "source_prefix": "bhargs/1-Enrollment/1-Enrollment/optum",
        ...
        "sources": [
            {
                "source_name": "safeharbor_cinqcare_elig_202604",
                "prefix": "bhargs/1-Enrollment/1-Enrollment/optum",
                "filename_regex": "safeharbor_CINQCare_Elig_202604.csv",
    ...
    _submit_params = {
        ...
        "job_config": {
            ...
            "name": "{{ dag.dag_id }}_run_pipelines_optum_1_{{ ts_nodash }}",
            "python_file": "/Workspace/Shared/dev-utils/pipelines/main.py",
            "parameters": [
                "/Workspace/Shared/codespace/test/pipelines/bh_project_id=299/pipeline/pipeline_id=1094/optum_1.json",
                "databricks",
    ...
    run_pipelines_optum_1 = PythonOperator(
        pre_execute=common_task.pre_execute_callback,
        task_id='run_pipelines_optum_1',
    ...
    _submit_params = {
        ...
        "job_config": {
            "job_type": "spark_python",
            "name": "{{ dag.dag_id }}_run_pipelines_silver_raw_cinqcare_elig_to_members_load_260619_d886_{{ ts_nodash }}",
            "python_file": "/Workspace/Shared/dev-utils/pipelines/main.py",
            "parameters": [
                "/Workspace/Shared/codespace/test/pipelines/bh_project_id=299/pipeline/pipeline_id=1095/silver_raw_cinqcare_elig_to_members_load_260619_d886.json",
                "databricks",
                "/Workspace/Shared/dev-utils/schemas"
            ]
        },
        ...
        "validate_inbound_task_id": "validate_inbound_files",
        "facts_source": "databricks",
        "pipeline_name": "silver_raw_cinqcare_elig_to_members_load_260619_d886",
        "compute_xcom_key": "return_value",
        "valid_files": "{{ task_instance.xcom_pull(task_ids='validate_inbound_files', key='valid_files') }}",
        "batch_id": "{{ task_instance.xcom_pull(task_ids='validate_inbound_files', key='batch_id') }}"
    }
    run_pipelines_silver_raw_cinqcare_elig_to_members_load_260619_d886 = PythonOperator(
        pre_execute=common_task.pre_execute_callback,
        task_id='run_pipelines_silver_raw_cinqcare_elig_to_members_load_260619_d886',
        python_callable=submit_job_to_cluster,
        params=_submit_params,
        on_success_callback=feed_control_callbacks.submit_job_success_callback,
        on_failure_callback=feed_control_callbacks.submit_job_failure_callback,
    ...
    _archive_params = {
        "bucket_name": "my-test-bucket",
        "source_prefix": "",
        "archive_prefix": "Archive/bhargs/1-Enrollment/1-Enrollment/optum",
        "cloud_type": "databricks",
        "airflow_connection_id": "databricks_default",
        "secret_name": "bh-dev-westus3-kv-key-scope/bh-azureblob-azureblob",
        "delete_source": True,
    ...
    create_compute >> run_pipelines_optum_1
    run_pipelines_optum_1 >> run_pipelines_silver_raw_cinqcare_elig_to_members_load_260619_d886
    create_compute >> run_pipelines_silver_raw_cinqcare_elig_to_members_load_260619_d886
    run_pipelines_silver_raw_cinqcare_elig_to_members_load_260619_d886 >> archive_processed_files
