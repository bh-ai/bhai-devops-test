...
common_task = CommonTask(dag_id='claim_op12_978_768', dag_params={})
lineage_task = LineageTask(dag_id='claim_op12_978_768', dag_params={})
...
with DAG(
    ...
    start_flow_task = PythonOperator(
        ...
        params = {
            'flow_id': 768,
            'flow_name': 'claim_op12_978',
            'flow_key': 'claim_op12_978',
            'bh_project_id': 299,
    ...
    _validate_params = {
        ...
        "sources": [
            {
                "source_name": "safeharborfideliscareprodopclaimheaderfullcinqdownstate",
                "prefix": "bhargs/3-Claims/3-Claims/Fidelis/Downstate/OP",
                "filename_regex": "^safeharbor_FidelisCare_Prod_OPClaimHeader_FULL_CINQDOWNSTATE11_[0-9]{8}_[0-9]{8}[.]txt$",
            ...
            {
                "source_name": "safeharborfideliscareprodopclaimlinefullcinqdownstate",
                "prefix": "bhargs/3-Claims/3-Claims/Fidelis/Downstate/OP",
                "filename_regex": "^safeharbor_FidelisCare_Prod_OPClaimLine_FULL_CINQDOWNSTATE11_[0-9]{8}_[0-9]{8}[.]txt$",
                "ignore_subfolders": True,
                "is_required": True,
                "min_bytes": 10,
                "min_files": 1
        ...
        payload = (
            {
                ...
                "spark_conf": {
                    ...
                    "spark.costanalyzer.outputDir": "abfss://my-test-bucket@bhnprddwestus3rgbd5e.dfs.core.windows.net/spark-metrics/768/claim_op12_978/",
                    "spark.flow.id": "768",
    ...
    _submit_params = {
        ...
        "job_config": {
            ...
            "parameters": [
                "/Workspace/Shared/codespace/pipelines/bh_project_id=299/pipeline/pipeline_id=1901/claim_op12.json",
                "databricks",
                "/Workspace/Shared/dev-utils/schemas"
            ],
            "spark_conf": {
                "spark.pipeline.id": "1901",
                "spark.pipeline.name": "claim_op12"
            }
        },
        "ingestion_group_id": 978,
        "flow_id": 768,
    ...
    _submit_params = {
        ...
        "job_config": {
            "job_type": "spark_python",
            "name": "{{ dag.dag_id }}_run_pipelines_silver_raw_fidelis_op_claims_to_healthcare_model_260922_866e_{{ ts_nodash }}",
            "python_file": "/Workspace/Shared/dev-utils/pipelines/main.py",
            "parameters": [
                "/Workspace/Shared/codespace/pipelines/bh_project_id=299/pipeline/pipeline_id=1902/silver_raw_fidelis_op_claims_to_healthcare_model_260922_866e.json",
                "databricks",
                "/Workspace/Shared/dev-utils/schemas"
            ],
            "spark_conf": {
                "spark.pipeline.id": "1902",
                "spark.pipeline.name": "silver_raw_fidelis_op_claims_to_healthcare_model_260922_866e"
            }
        },
        "ingestion_group_id": 978,
        "flow_id": 768,
        ...
        "validate_inbound_task_id": "validate_inbound_files",
        "facts_source": "databricks",
        "pipeline_name": "silver_raw_fidelis_op_claims_to_healthcare_model_260922_866e",
        "run_data_quality_rules": False,
        "dq_rules_source": "git",
        "metrics_output_dir": "abfss://my-test-bucket@bhnprddwestus3rgbd5e.dfs.core.windows.net/spark-metrics/768/claim_op12_978/",
        "blob_secrets_scope": "bh-dev-test-key-scope",
        ...
        "cloud_provider": "databricks",
        "airflow_connection_id": "databricks_default",
        "pipeline_key": "silver_raw_fidelis_op_claims_to_healthcare_model_260922_866e",
        "bh_project_id": 299,
        "project_id": 299,
        "project_name": "flow-test-project",
        "metrics_ingest_max_wait_sec": 120,
    ...
    run_pipelines_silver_raw_fidelis_op_claims_to_healthcare_model_260922_866e = PythonOperator(
        pre_execute=common_task.pre_execute_callback,
        task_id='run_pipelines_silver_raw_fidelis_op_claims_to_healthcare_model_260922_866e',
        python_callable=submit_job_to_cluster,
        params=_submit_params,
        on_success_callback=feed_control_callbacks.submit_job_success_callback,
        on_failure_callback=feed_control_callbacks.submit_job_failure_callback,
    ...
    _submit_params = {
        ...
        "job_config": {
            "job_type": "spark_python",
            "name": "{{ dag.dag_id }}_run_pipelines_claims_silver_ods_fidelis_upstate_ip_new_{{ ts_nodash }}",
            "python_file": "/Workspace/Shared/dev-utils/pipelines/main.py",
            "parameters": [
                "/Workspace/Shared/codespace/pipelines/bh_project_id=299/pipeline/pipeline_id=1903/claims_silver_ods_fidelis_upstate_ip_new.json",
                "databricks",
                "/Workspace/Shared/dev-utils/schemas"
            ],
            "spark_conf": {
                "spark.pipeline.id": "1903",
                "spark.pipeline.name": "claims_silver_ods_fidelis_upstate_IP_new"
            }
        },
        "ingestion_group_id": 978,
        "flow_id": 768,
    ...
    run_pipelines_claims_silver_ods_fidelis_upstate_ip_new = PythonOperator(
        pre_execute=common_task.pre_execute_callback,
        task_id='run_pipelines_claims_silver_ods_fidelis_upstate_ip_new',
        python_callable=submit_job_to_cluster,
        params=_submit_params,
        on_success_callback=feed_control_callbacks.submit_job_success_callback,
        on_failure_callback=feed_control_callbacks.submit_job_failure_callback,
    ...
    run_pipelines_silver_raw_fidelis_op_claims_to_healthcare_model_260922_866e >> run_pipelines_claims_silver_ods_fidelis_upstate_ip_new
    create_compute >> run_pipelines_claims_silver_ods_fidelis_upstate_ip_new
    run_pipelines_claims_silver_ods_fidelis_upstate_ip_new >> archive_processed_files
