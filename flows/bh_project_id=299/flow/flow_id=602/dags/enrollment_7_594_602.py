...
common_task = CommonTask(dag_id='enrollment_7_594_602', dag_params={})
lineage_task = LineageTask(dag_id='enrollment_7_594_602', dag_params={})
...
with DAG(
    ...
    start_flow_task = PythonOperator(
        ...
        params = {
            'flow_id': 602,
            'flow_name': 'enrollment_7_594',
            'flow_key': 'enrollment_7_594',
            'bh_project_id': 299,
    ...
    run_pipelines_enrollment_7 = PythonOperator(
        pre_execute=common_task.pre_execute_callback,
        task_id='run_pipelines_enrollment_7',
    ...
    _submit_params = {
        ...
        "validate_inbound_task_id": "validate_inbound_files",
        "facts_source": "databricks",
        "pipeline_name": "silver_raw_cinqcare_member_file_parse_and_load_260619_a289",
        "compute_xcom_key": "return_value",
        "valid_files": "{{ task_instance.xcom_pull(task_ids='validate_inbound_files', key='valid_files') }}",
        "batch_id": "{{ task_instance.xcom_pull(task_ids='validate_inbound_files', key='batch_id') }}"
    }
    run_pipelines_silver_raw_cinqcare_member_file_parse_and_load_260619_a289 = PythonOperator(
        pre_execute=common_task.pre_execute_callback,
        task_id='run_pipelines_silver_raw_cinqcare_member_file_parse_and_load_260619_a289',
        python_callable=submit_job_to_cluster,
        params=_submit_params,
        on_success_callback=feed_control_callbacks.submit_job_success_callback,
        on_failure_callback=feed_control_callbacks.submit_job_failure_callback,
    ...
    create_compute >> run_pipelines_enrollment_7
    run_pipelines_enrollment_7 >> run_pipelines_silver_raw_cinqcare_member_file_parse_and_load_260619_a289
    create_compute >> run_pipelines_silver_raw_cinqcare_member_file_parse_and_load_260619_a289
    run_pipelines_silver_raw_cinqcare_member_file_parse_and_load_260619_a289 >> archive_processed_files
