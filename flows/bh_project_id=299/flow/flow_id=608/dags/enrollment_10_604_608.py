...
common_task = CommonTask(dag_id='enrollment_10_604_608', dag_params={})
lineage_task = LineageTask(dag_id='enrollment_10_604_608', dag_params={})
...
with DAG(
    ...
    start_flow_task = PythonOperator(
        ...
        params = {
            'flow_id': 608,
            'flow_name': 'enrollment_10_604',
            'flow_key': 'enrollment_10_604',
            'bh_project_id': 299,
    ...
    run_pipelines_enrollment_10 = PythonOperator(
        pre_execute=common_task.pre_execute_callback,
        task_id='run_pipelines_enrollment_10',
    ...
    _submit_params = {
        ...
        "job_config": {
            "job_type": "spark_python",
            "name": "{{ dag.dag_id }}_run_pipelines_silver_raw_cinqcare_member_enrollment_load_260622_019f_{{ ts_nodash }}",
            "python_file": "/Workspace/Shared/dev-utils/pipelines/main.py",
            "parameters": [
                "/Workspace/Shared/codespace/test/pipelines/bh_project_id=299/pipeline/pipeline_id=1103/silver_raw_cinqcare_member_enrollment_load_260622_019f.json",
                "databricks",
                "/Workspace/Shared/dev-utils/schemas"
            ]
        },
        ...
        "validate_inbound_task_id": "validate_inbound_files",
        "facts_source": "databricks",
        "pipeline_name": "silver_raw_cinqcare_member_enrollment_load_260622_019f",
        "compute_xcom_key": "return_value",
        "valid_files": "{{ task_instance.xcom_pull(task_ids='validate_inbound_files', key='valid_files') }}",
        "batch_id": "{{ task_instance.xcom_pull(task_ids='validate_inbound_files', key='batch_id') }}"
    }
    run_pipelines_silver_raw_cinqcare_member_enrollment_load_260622_019f = PythonOperator(
        pre_execute=common_task.pre_execute_callback,
        task_id='run_pipelines_silver_raw_cinqcare_member_enrollment_load_260622_019f',
        python_callable=submit_job_to_cluster,
        params=_submit_params,
        on_success_callback=feed_control_callbacks.submit_job_success_callback,
        on_failure_callback=feed_control_callbacks.submit_job_failure_callback,
    ...
    create_compute >> run_pipelines_enrollment_10
    run_pipelines_enrollment_10 >> run_pipelines_silver_raw_cinqcare_member_enrollment_load_260622_019f
    create_compute >> run_pipelines_silver_raw_cinqcare_member_enrollment_load_260622_019f
    run_pipelines_silver_raw_cinqcare_member_enrollment_load_260622_019f >> archive_processed_files
