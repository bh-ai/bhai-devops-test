...
with DAG(
    ...
    _submit_params = {
        ...
        "job_config": {
            ...
            "parameters": [
                "/Workspace/Shared/codespace/pipelines/bh_project_id=299/pipeline/pipeline_id=1280/ingestiongroup1607a.json",
                "databricks",
    ...
    _submit_params = {
        ...
        "job_config": {
            ...
            "python_file": "/Workspace/Shared/dev-utils/pipelines/main.py",
            "parameters": [
                "/Workspace/Shared/codespace/pipelines/bh_project_id=299/pipeline/pipeline_id=1281/silver_raw_safeharbor_to_members_dedupe_load_260716_3ff7.json",
                "databricks",
                "/Workspace/Shared/dev-utils/schemas"
            ],
            "spark_conf": {
