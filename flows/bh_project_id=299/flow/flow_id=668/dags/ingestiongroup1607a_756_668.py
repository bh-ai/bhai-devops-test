...
common_task = CommonTask(dag_id='ingestiongroup1607a_756_668', dag_params={})
lineage_task = LineageTask(dag_id='ingestiongroup1607a_756_668', dag_params={})
...
with DAG(
    dag_id='ingestiongroup1607a_756_668',
    ...
    start_flow_task = PythonOperator(
        ...
        params = {
            'flow_id': 668,
            'flow_name': 'ingestiongroup1607a_756',
            'flow_key': 'ingestiongroup1607a_756',
            'bh_project_id': 299,
    ...
    _validate_params = {
        ...
        "source_prefix": "bhargs/1-Enrollment/1-Enrollment/Fedelis NY/Downstate",
        ...
        "min_files": 1,
        "max_files": None,
        "quarantine_prefix": "bhargs/1-Enrollment/1-Enrollment/Fedelis NY/Downstate/rejected",
        "fail_on_invalid": True,
        "sources": [
            {
                "source_name": "safeharbor_cinqdownstate_member_roster_04_03_2026",
                "prefix": "bhargs/1-Enrollment/1-Enrollment/Fedelis NY/Downstate",
                "filename_regex": "safeharbor__CINQDOWNSTATE_Member_Roster_04_03_2026.csv",
        ...
        "control_schema": None,
        "feed_name": "ingestiongroup1607a",
        "feed_id": "ingestiongroup1607a"
    }
        ...
        payload = (
            {
                ...
                "spark_conf": {
                    ...
                    "spark.costanalyzer.outputDir": "abfss://my-test-bucket@bhnprddwestus3rgbd5e.dfs.core.windows.net/spark-metrics/668/ingestiongroup1607a_756/",
                    "spark.flow.id": "668",
    ...
    _submit_params = {
        ...
        "job_config": {
            ...
            "name": "{{ dag.dag_id }}_run_pipelines_ingestiongroup1607a_{{ ts_nodash }}",
            "python_file": "/Workspace/Shared/dev-utils/pipelines/main.py",
            "parameters": [
                "/Workspace/Shared/codespace/test/pipelines/bh_project_id=299/pipeline/pipeline_id=1280/ingestiongroup1607a.json",
                "databricks",
                "/Workspace/Shared/dev-utils/schemas"
            ],
            "spark_conf": {
                "spark.pipeline.id": "1280",
                "spark.pipeline.name": "ingestiongroup1607a"
            }
        },
        "ingestion_group_id": 756,
        "flow_id": 668,
        ...
        "pipeline_name": "ingestiongroup1607a",
        "metrics_output_dir": "abfss://my-test-bucket@bhnprddwestus3rgbd5e.dfs.core.windows.net/spark-metrics/668/ingestiongroup1607a_756/",
        "blob_secrets_scope": "bh-dev-test-key-scope",
        ...
        "airflow_connection_id": "databricks_default",
        "pipeline_key": "ingestiongroup1607a",
    ...
    run_pipelines_ingestiongroup1607a = PythonOperator(
        pre_execute=common_task.pre_execute_callback,
        task_id='run_pipelines_ingestiongroup1607a',
    ...
    _submit_params = {
        ...
        "job_config": {
            "job_type": "spark_python",
            "name": "{{ dag.dag_id }}_run_pipelines_silver_raw_safeharbor_to_members_dedupe_load_260716_3ff7_{{ ts_nodash }}",
            "python_file": "/Workspace/Shared/dev-utils/pipelines/main.py",
            "parameters": [
                "/Workspace/Shared/codespace/test/pipelines/bh_project_id=299/pipeline/pipeline_id=1281/silver_raw_safeharbor_to_members_dedupe_load_260716_3ff7.json",
                "databricks",
                "/Workspace/Shared/dev-utils/schemas"
            ],
            "spark_conf": {
                "spark.pipeline.id": "1281",
                "spark.pipeline.name": "silver_raw_safeharbor_to_members_dedupe_load_260716_3ff7"
            }
        },
        "ingestion_group_id": 756,
        "flow_id": 668,
        ...
        "validate_inbound_task_id": "validate_inbound_files",
        "facts_source": "databricks",
        "pipeline_name": "silver_raw_safeharbor_to_members_dedupe_load_260716_3ff7",
        "metrics_output_dir": "abfss://my-test-bucket@bhnprddwestus3rgbd5e.dfs.core.windows.net/spark-metrics/668/ingestiongroup1607a_756/",
        "blob_secrets_scope": "bh-dev-test-key-scope",
        "metrics_storage_secret_name": "bh-dev-westus3-kv-key-scope/bh-azureblob-azureblob",
        "keycloak_secret_name": "bh-dev-westus3-kv-key-scope/bh-app-sathish-databricks-keycloak-331-v1-secrets",
        ...
        "cloud_provider": "databricks",
        "airflow_connection_id": "databricks_default",
        "pipeline_key": "silver_raw_safeharbor_to_members_dedupe_load_260716_3ff7",
        "compute_xcom_key": "return_value",
        "valid_files": "{{ task_instance.xcom_pull(task_ids='validate_inbound_files', key='valid_files') }}",
        "batch_id": "{{ task_instance.xcom_pull(task_ids='validate_inbound_files', key='batch_id') }}"
    }
    run_pipelines_silver_raw_safeharbor_to_members_dedupe_load_260716_3ff7 = PythonOperator(
        pre_execute=common_task.pre_execute_callback,
        task_id='run_pipelines_silver_raw_safeharbor_to_members_dedupe_load_260716_3ff7',
        python_callable=submit_job_to_cluster,
        params=_submit_params,
        on_success_callback=feed_control_callbacks.submit_job_success_callback,
        on_failure_callback=feed_control_callbacks.submit_job_failure_callback,
    ...
    _archive_params = {
        "bucket_name": "my-test-bucket",
        "source_prefix": "",
        "archive_prefix": "Archive/bhargs/1-Enrollment/1-Enrollment/Fedelis NY/Downstate",
        "cloud_type": "databricks",
        "airflow_connection_id": "databricks_default",
        "secret_name": "bh-dev-westus3-kv-key-scope/bh-azureblob-azureblob",
        "delete_source": True,
    ...
    create_compute >> run_pipelines_ingestiongroup1607a
    run_pipelines_ingestiongroup1607a >> run_pipelines_silver_raw_safeharbor_to_members_dedupe_load_260716_3ff7
    create_compute >> run_pipelines_silver_raw_safeharbor_to_members_dedupe_load_260716_3ff7
    run_pipelines_silver_raw_safeharbor_to_members_dedupe_load_260716_3ff7 >> archive_processed_files
