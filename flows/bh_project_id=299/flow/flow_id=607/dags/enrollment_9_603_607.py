...
common_task = CommonTask(dag_id='enrollment_9_603_607', dag_params={})
lineage_task = LineageTask(dag_id='enrollment_9_603_607', dag_params={})
...
with DAG(
    ...
    start_flow_task = PythonOperator(
        ...
        params = {
            'flow_id': 607,
            'flow_name': 'enrollment_9_603',
            'flow_key': 'enrollment_9_603',
            'bh_project_id': 299,
    ...
    _validate_params = {
        ...
        "source_prefix": "bhargs/1-Enrollment/1-Enrollment/Centene GA Risk",
        ...
        "sources": [
            {
                ...
                "prefix": "bhargs/1-Enrollment/1-Enrollment/Centene GA Risk",
                "filename_regex": "CinqCare Member File 8.21.25.csv",
    ...
    _submit_params = {
        ...
        "job_config": {
            ...
            "name": "{{ dag.dag_id }}_run_pipelines_enrollment_9_{{ ts_nodash }}",
            "python_file": "/Workspace/Shared/dev-utils/pipelines/main.py",
            "parameters": [
                "/Workspace/Shared/codespace/test/pipelines/bh_project_id=299/pipeline/pipeline_id=1100/enrollment_9.json",
                "databricks",
    ...
    run_pipelines_enrollment_9 = PythonOperator(
        pre_execute=common_task.pre_execute_callback,
        task_id='run_pipelines_enrollment_9',
    ...
    _submit_params = {
        ...
        "job_config": {
            "job_type": "spark_python",
            "name": "{{ dag.dag_id }}_run_pipelines_silver_raw_cinqcare_member_enrollment_load_260622_092d_{{ ts_nodash }}",
            "python_file": "/Workspace/Shared/dev-utils/pipelines/main.py",
            "parameters": [
                "/Workspace/Shared/codespace/test/pipelines/bh_project_id=299/pipeline/pipeline_id=1101/silver_raw_cinqcare_member_enrollment_load_260622_092d.json",
                "databricks",
                "/Workspace/Shared/dev-utils/schemas"
            ]
        },
        ...
        "validate_inbound_task_id": "validate_inbound_files",
        "facts_source": "databricks",
        "pipeline_name": "silver_raw_cinqcare_member_enrollment_load_260622_092d",
        "compute_xcom_key": "return_value",
        "valid_files": "{{ task_instance.xcom_pull(task_ids='validate_inbound_files', key='valid_files') }}",
        "batch_id": "{{ task_instance.xcom_pull(task_ids='validate_inbound_files', key='batch_id') }}"
    }
    run_pipelines_silver_raw_cinqcare_member_enrollment_load_260622_092d = PythonOperator(
        pre_execute=common_task.pre_execute_callback,
        task_id='run_pipelines_silver_raw_cinqcare_member_enrollment_load_260622_092d',
        python_callable=submit_job_to_cluster,
        params=_submit_params,
        on_success_callback=feed_control_callbacks.submit_job_success_callback,
        on_failure_callback=feed_control_callbacks.submit_job_failure_callback,
    ...
    _archive_params = {
        "bucket_name": "my-test-bucket",
        "source_prefix": "",
        "archive_prefix": "Archive/bhargs/1-Enrollment/1-Enrollment/Centene GA Risk",
        "cloud_type": "databricks",
        "airflow_connection_id": "databricks_default",
        "secret_name": "bh-dev-westus3-kv-key-scope/bh-azureblob-azureblob",
        "delete_source": True,
    ...
    create_compute >> run_pipelines_enrollment_9
    run_pipelines_enrollment_9 >> run_pipelines_silver_raw_cinqcare_member_enrollment_load_260622_092d
    create_compute >> run_pipelines_silver_raw_cinqcare_member_enrollment_load_260622_092d
    run_pipelines_silver_raw_cinqcare_member_enrollment_load_260622_092d >> archive_processed_files
