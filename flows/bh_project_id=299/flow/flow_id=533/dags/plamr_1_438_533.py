...
common_task = CommonTask(dag_id='plamr_1_438_533', dag_params={})
lineage_task = LineageTask(dag_id='plamr_1_438_533', dag_params={})
...
with DAG(
    ...
    start_flow_task = PythonOperator(
        ...
        params = {
            'flow_id': 533,
            'flow_name': 'plamr-1_438',
            'flow_key': 'plamr_1_438',
            'bh_project_id': 299,
    ...
    _validate_params = {
        ...
        "source_prefix": "bhargs/1-Enrollment/1-Enrollment/palmr_dat",
        ...
        "sources": [
            {
                "source_name": "palmr",
                "prefix": "bhargs/1-Enrollment/1-Enrollment/palmr_dat",
                "filename_regex": "palmr.dat",
    ...
    _submit_params = {
        ...
        "job_config": {
            ...
            "name": "{{ dag.dag_id }}_run_pipelines_plamr_1_{{ ts_nodash }}",
            "python_file": "/Workspace/Shared/dev-utils/pipelines/main.py",
            "parameters": [
                "/Workspace/Shared/codespace/test/pipelines/bh_project_id=299/pipeline/pipeline_id=872/plamr_1.json",
                "databricks",
    ...
    run_pipelines_plamr_1 = PythonOperator(
        pre_execute=common_task.pre_execute_callback,
        task_id='run_pipelines_plamr_1',
    ...
    _archive_params = {
        "bucket_name": "my-test-bucket",
        "source_prefix": "",
        "archive_prefix": "Archive/bhargs/1-Enrollment/1-Enrollment/palmr_dat",
        "cloud_type": "databricks",
        "airflow_connection_id": "databricks_default",
        "secret_name": "bh-dev-westus3-kv-key-scope/bh-azureblob-azureblob",
        "delete_source": True,
    ...
    create_compute >> run_pipelines_plamr_1
    run_pipelines_plamr_1 >> archive_processed_files
