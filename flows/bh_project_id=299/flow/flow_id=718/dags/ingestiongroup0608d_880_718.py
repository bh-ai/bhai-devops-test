...
common_task = CommonTask(dag_id='ingestiongroup0608d_880_718', dag_params={})
lineage_task = LineageTask(dag_id='ingestiongroup0608d_880_718', dag_params={})
...
with DAG(
    dag_id='ingestiongroup0608d_880_718',
    ...
    start_flow_task = PythonOperator(
        ...
        params = {
            'flow_id': 718,
            'flow_name': 'ingestiongroup0608d_880',
            'flow_key': 'ingestiongroup0608d_880',
            'bh_project_id': 299,
    ...
    _validate_params = {
        ...
        "feed_name": "ingestiongroup0608d",
        "feed_id": "ingestiongroup0608d"
    }
    ...
    _submit_params = {
        ...
        "job_config": {
            ...
            "name": "{{ dag.dag_id }}_run_pipelines_ingestiongroup0608d_{{ ts_nodash }}",
            "python_file": "/Workspace/Shared/dev-utils/pipelines/main.py",
            "parameters": [
                "/Workspace/Shared/codespace/pipelines/bh_project_id=299/pipeline/pipeline_id=1513/ingestiongroup0608d.json",
                "databricks",
        ...
        "pipeline_name": "ingestiongroup0608d",
        "airflow_connection_id": "databricks_default",
        "pipeline_key": "ingestiongroup0608d",
        "bh_project_id": 299,
        "project_id": 299,
        "project_name": "flow-test-project",
    ...
    run_pipelines_ingestiongroup0608d = PythonOperator(
        pre_execute=common_task.pre_execute_callback,
        task_id='run_pipelines_ingestiongroup0608d',
    ...
    _submit_params = {
        ...
        "job_config": {
            "job_type": "spark_python",
            "name": "{{ dag.dag_id }}_run_pipelines_silver_raw_safeharbor_to_members_dedupe_load_260806_6ad4_{{ ts_nodash }}",
            "python_file": "/Workspace/Shared/dev-utils/pipelines/main.py",
            "parameters": [
                "/Workspace/Shared/codespace/pipelines/bh_project_id=299/pipeline/pipeline_id=1515/silver_raw_safeharbor_to_members_dedupe_load_260806_6ad4.json",
                "databricks",
                "/Workspace/Shared/dev-utils/schemas"
            ]
        },
        ...
        "validate_inbound_task_id": "validate_inbound_files",
        "facts_source": "databricks",
        "pipeline_name": "silver_raw_safeharbor_to_members_dedupe_load_260806_6ad4",
        "airflow_connection_id": "databricks_default",
        "pipeline_key": "silver_raw_safeharbor_to_members_dedupe_load_260806_6ad4",
        "bh_project_id": 299,
        "project_id": 299,
        "project_name": "flow-test-project",
        "compute_xcom_key": "return_value",
    ...
    run_pipelines_silver_raw_safeharbor_to_members_dedupe_load_260806_6ad4 = PythonOperator(
        pre_execute=common_task.pre_execute_callback,
        task_id='run_pipelines_silver_raw_safeharbor_to_members_dedupe_load_260806_6ad4',
        python_callable=submit_job_to_cluster,
        params=_submit_params,
        on_success_callback=feed_control_callbacks.submit_job_success_callback,
        on_failure_callback=feed_control_callbacks.submit_job_failure_callback,
    ...
    create_compute >> run_pipelines_ingestiongroup0608d
    run_pipelines_ingestiongroup0608d >> run_pipelines_silver_raw_safeharbor_to_members_dedupe_load_260806_6ad4
    create_compute >> run_pipelines_silver_raw_safeharbor_to_members_dedupe_load_260806_6ad4
    run_pipelines_silver_raw_safeharbor_to_members_dedupe_load_260806_6ad4 >> archive_processed_files
