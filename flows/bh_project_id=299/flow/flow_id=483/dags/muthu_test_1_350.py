...
common_task = CommonTask(dag_id='muthu_test_1_350', dag_params={})
lineage_task = LineageTask(dag_id='muthu_test_1_350', dag_params={})
...
with DAG(
    ...
    start_flow_task = PythonOperator(
        ...
        params = {
            'flow_id': 483,
            'flow_name': 'muthu_test_1_350',
            'flow_key': 'muthu_test_1_350',
            'bh_project_id': 299,
    ...
    _submit_params = {
        ...
        "job_config": {
            ...
            "name": "{{ dag.dag_id }}_run_pipelines_muthu_test_1_{{ ts_nodash }}",
            "python_file": "/Workspace/Shared/dev-utils/pipelines/main.py",
            "parameters": [
                "/Workspace/Shared/codespace/test/pipelines/bh_project_id=299/pipeline/pipeline_id=749/muthu_test_1.json",
                "databricks",
    ...
    run_pipelines_muthu_test_1 = PythonOperator(
        pre_execute=common_task.pre_execute_callback,
        task_id='run_pipelines_muthu_test_1',
    ...
    _archive_params = {
        ...
        "files": [
            {
                "key": "bhargs/1-Enrollment/1-Enrollment/Centene GA Risk/CinqCare Member File 8.21.25.csv",
        ...
        "source_prefix": "",
        "archive_prefix": "bhargs/1-Enrollment/1-Enrollment/Centene GA Risk/archived/",
        "cloud_type": "databricks",
        "airflow_connection_id": "databricks_default",
        "secret_name": "bh-dev-westus3-kv-key-scope/bh-azureblob-azureblob",
        "delete_source": True,
    ...
    create_compute >> run_pipelines_muthu_test_1
    run_pipelines_muthu_test_1 >> archive_processed_files
