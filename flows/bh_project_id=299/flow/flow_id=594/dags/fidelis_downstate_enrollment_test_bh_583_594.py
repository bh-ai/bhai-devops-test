...
common_task = CommonTask(dag_id='fidelis_downstate_enrollment_test_bh_583_594', dag_params={})
lineage_task = LineageTask(dag_id='fidelis_downstate_enrollment_test_bh_583_594', dag_params={})
...
with DAG(
    dag_id='fidelis_downstate_enrollment_test_bh_583_594',
    ...
    start_flow_task = PythonOperator(
        ...
        params = {
            'flow_id': 594,
            'flow_name': 'Fidelis_downstate_enrollment_test_bh_583',
            'flow_key': 'fidelis_downstate_enrollment_test_bh_583',
            'bh_project_id': 299,
    ...
    _validate_params = {
        ...
        "source_prefix": "bhargs/1-Enrollment/1-Enrollment/fedelisny/Batch",
        ...
        "sources": [
            {
                ...
                "prefix": "bhargs/1-Enrollment/1-Enrollment/fedelisny/Batch",
        ...
        "feed_name": "Fidelis_downstate_enrollment_test_bh"
    }
    ...
    _submit_params = {
        ...
        "job_config": {
            ...
            "name": "{{ dag.dag_id }}_run_pipelines_fidelis_downstate_enrollment_test_bh_{{ ts_nodash }}",
            "python_file": "/Workspace/Shared/dev-utils/pipelines/main.py",
            "parameters": [
                "/Workspace/Shared/codespace/test/pipelines/bh_project_id=299/pipeline/pipeline_id=1072/fidelis_downstate_enrollment_test_bh.json",
                "databricks",
        ...
        "pipeline_name": "Fidelis_downstate_enrollment_test_bh",
    ...
    run_pipelines_fidelis_downstate_enrollment_test_bh = PythonOperator(
        pre_execute=common_task.pre_execute_callback,
        task_id='run_pipelines_fidelis_downstate_enrollment_test_bh',
    ...
    _submit_params = {
        ...
        "job_config": {
            "job_type": "spark_python",
            "name": "{{ dag.dag_id }}_run_pipelines_silver_raw_fidelis_ny_downstate_enrollment_to_members_dedupe_load_260616_67cd_{{ ts_nodash }}",
            "python_file": "/Workspace/Shared/dev-utils/pipelines/main.py",
            "parameters": [
                "/Workspace/Shared/codespace/test/pipelines/bh_project_id=299/pipeline/pipeline_id=1073/silver_raw_fidelis_ny_downstate_enrollment_to_members_dedupe_load_260616_67cd.json",
                "databricks",
                "/Workspace/Shared/dev-utils/schemas"
            ]
        },
        ...
        "validate_inbound_task_id": "validate_inbound_files",
        "facts_source": "databricks",
        "pipeline_name": "silver_raw_fidelis_ny_downstate_enrollment_to_members_dedupe_load_260616_67cd",
        "compute_xcom_key": "return_value",
        "valid_files": "{{ task_instance.xcom_pull(task_ids='validate_inbound_files', key='valid_files') }}",
        "batch_id": "{{ task_instance.xcom_pull(task_ids='validate_inbound_files', key='batch_id') }}"
    }
    run_pipelines_silver_raw_fidelis_ny_downstate_enrollment_to_members_dedupe_load_260616_67cd = PythonOperator(
        pre_execute=common_task.pre_execute_callback,
        task_id='run_pipelines_silver_raw_fidelis_ny_downstate_enrollment_to_members_dedupe_load_260616_67cd',
        python_callable=submit_job_to_cluster,
        params=_submit_params,
        on_success_callback=feed_control_callbacks.submit_job_success_callback,
        on_failure_callback=feed_control_callbacks.submit_job_failure_callback,
    ...
    _archive_params = {
        "bucket_name": "my-test-bucket",
        "source_prefix": "",
        "archive_prefix": "Archive/bhargs/1-Enrollment/1-Enrollment/fedelisny/Batch",
        "cloud_type": "databricks",
        "airflow_connection_id": "databricks_default",
        "secret_name": "bh-dev-westus3-kv-key-scope/bh-azureblob-azureblob",
        "delete_source": True,
    ...
    create_compute >> run_pipelines_fidelis_downstate_enrollment_test_bh
    run_pipelines_fidelis_downstate_enrollment_test_bh >> run_pipelines_silver_raw_fidelis_ny_downstate_enrollment_to_members_dedupe_load_260616_67cd
    create_compute >> run_pipelines_silver_raw_fidelis_ny_downstate_enrollment_to_members_dedupe_load_260616_67cd
    run_pipelines_silver_raw_fidelis_ny_downstate_enrollment_to_members_dedupe_load_260616_67cd >> archive_processed_files
