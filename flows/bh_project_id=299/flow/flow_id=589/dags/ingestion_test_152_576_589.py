...
common_task = CommonTask(dag_id='ingestion_test_152_576_589', dag_params={})
lineage_task = LineageTask(dag_id='ingestion_test_152_576_589', dag_params={})
...
with DAG(
    dag_id='ingestion_test_152_576_589',
    ...
    start_flow_task = PythonOperator(
        ...
        params = {
            'flow_id': 589,
            'flow_name': 'ingestion-test-152_576',
            'flow_key': 'ingestion_test_152_576',
            'bh_project_id': 299,
    ...
    _submit_params = {
        ...
        "pipeline_name": "ingestion-test-152",
    ...
    run_pipelines_ingestion_test_152 = PythonOperator(
        pre_execute=common_task.pre_execute_callback,
        task_id='run_pipelines_ingestion_test_152',
    ...
    _submit_params = {
        ...
        "validate_inbound_task_id": "validate_inbound_files",
        "facts_source": "databricks",
        "pipeline_name": "silver_raw_fidelis_ny_downstate_enrollment_to_members_dedupe_load_260615_5583",
        "compute_xcom_key": "return_value",
        "valid_files": "{{ task_instance.xcom_pull(task_ids='validate_inbound_files', key='valid_files') }}",
        "batch_id": "{{ task_instance.xcom_pull(task_ids='validate_inbound_files', key='batch_id') }}"
    }
    run_pipelines_silver_raw_fidelis_ny_downstate_enrollment_to_members_dedupe_load_260615_5583 = PythonOperator(
        pre_execute=common_task.pre_execute_callback,
        task_id='run_pipelines_silver_raw_fidelis_ny_downstate_enrollment_to_members_dedupe_load_260615_5583',
        python_callable=submit_job_to_cluster,
        params=_submit_params,
        on_success_callback=feed_control_callbacks.submit_job_success_callback,
        on_failure_callback=feed_control_callbacks.submit_job_failure_callback,
    ...
    create_compute >> run_pipelines_ingestion_test_152
    run_pipelines_ingestion_test_152 >> run_pipelines_silver_raw_fidelis_ny_downstate_enrollment_to_members_dedupe_load_260615_5583
    create_compute >> run_pipelines_silver_raw_fidelis_ny_downstate_enrollment_to_members_dedupe_load_260615_5583
    run_pipelines_silver_raw_fidelis_ny_downstate_enrollment_to_members_dedupe_load_260615_5583 >> archive_processed_files
