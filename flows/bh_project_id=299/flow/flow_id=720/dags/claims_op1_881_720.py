...
common_task = CommonTask(dag_id='claims_op1_881_720', dag_params={})
lineage_task = LineageTask(dag_id='claims_op1_881_720', dag_params={})
...
with DAG(
    ...
    start_flow_task = PythonOperator(
        ...
        params = {
            'flow_id': 720,
            'flow_name': 'claims_op1_881',
            'flow_key': 'claims_op1_881',
            'bh_project_id': 299,
    ...
    _validate_params = {
        ...
        "source_prefix": "bhargs/3-Claims/3-Claims/Fidelis/upstate/op_test",
        ...
        "min_files": 1,
        "max_files": None,
        "quarantine_prefix": "bhargs/3-Claims/3-Claims/Fidelis/upstate/op_test/rejected",
        "fail_on_invalid": True,
        "use_valid_files_manifest": False,
        "runtime_params_base_path": "/Workspace/Shared/runtime_params",
        "sources": [
            {
                "source_name": "safeharbor_fideliscare_prod_opclaimheader_full_cinqupstate_20230101_20260331_1",
                "prefix": "bhargs/3-Claims/3-Claims/Fidelis/upstate/op_test",
                "filename_regex": "safeharbor_FidelisCare_Prod_OPClaimHeader_FULL_CINQUPSTATE_.*.txt",
    ...
    _submit_params = {
        ...
        "job_config": {
            ...
            "name": "{{ dag.dag_id }}_run_pipelines_claims_op1_{{ ts_nodash }}",
            "python_file": "/Workspace/Shared/dev-utils/pipelines/main.py",
            "parameters": [
                "/Workspace/Shared/codespace/pipelines/bh_project_id=299/pipeline/pipeline_id=1517/claims_op1.json",
                "databricks",
        ...
        "pipeline_name": "claims_op1",
        "airflow_connection_id": "databricks_default",
        "pipeline_key": "claims_op1",
        "bh_project_id": 299,
        "project_id": 299,
        "project_name": "flow-test-project",
    ...
    run_pipelines_claims_op1 = PythonOperator(
        pre_execute=common_task.pre_execute_callback,
        task_id='run_pipelines_claims_op1',
    ...
    _archive_params = {
        "bucket_name": "my-test-bucket",
        "source_prefix": "",
        "archive_prefix": "Archive/bhargs/3-Claims/3-Claims/Fidelis/upstate/op_test",
        "cloud_type": "databricks",
        "airflow_connection_id": "databricks_default",
        "secret_name": "bh-dev-westus3-kv-key-scope/bh-azureblob-azureblob",
        "delete_source": True,
    ...
    create_compute >> run_pipelines_claims_op1
    run_pipelines_claims_op1 >> archive_processed_files
